package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_50:IHabboCommunicationManager;
      ...
      private var var_2643:PseudoRandom;
      ...
      private var var_227:HabboHotelView;
      
      private var var_1443:String = "";
      
      private const const_1689:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_626 = param1;
            this.var_50.initConnection(HabboConnectionType.const_208);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_50 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_50.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_50.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_50.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_50.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_50.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_50.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_50.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_50.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_50.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_50.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_50.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_50.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_50.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_50.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_50.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_50 && this.var_159 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_227 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_159.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_159.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_227.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_159.getKey("use.sso.ticket") == "1";
         this.var_626 = this.var_159.getKey("sso.ticket",null);
         this.var_1876 = this.var_159.getKey("flash.client.url","");
         this.var_2644 = this.var_159.getKey("external.variables.txt","");
         if(this.var_227 == null)
         {
            this.var_227 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_50.mode = HabboConnectionType.const_120;
            if(this.var_626)
            {
               this.var_50.initConnection(HabboConnectionType.const_208);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_475,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_50.mode = HabboConnectionType.const_120;
            if(this.var_159.keyExists("local.environment"))
            {
               this.var_50.mode = HabboConnectionType.const_986;
            }
         }
         this.var_50.initConnection(HabboConnectionType.const_208);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_50.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_865);
            _loc3_ = new InitCryptoMessageComposer(this.var_50.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2643 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_50.mode)
         {
            case HabboConnectionType.const_120:
               _loc6_ = "";
               _loc6_ = this.var_159.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_159.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1443 = _loc4_;
               this.var_227.loadBannerImage(_loc7_ + "?token=" + this.var_1443,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_986:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1543:
               this.var_968 = this.generateRandomHexString(30);
               this.var_517 = new DiffieHellman(new BigInteger(this.var_159.getKey("connection.development.prime"),16),new BigInteger(this.var_159.getKey("connection.development.generator"),16));
               this.var_517.init(this.var_968);
               _loc8_ = this.var_517.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_50.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2643);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1444 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_262);
         connection.send(new VersionCheckMessageComposer(401,this.var_1876,this.var_2644));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1689,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_626 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_626);
            _loc2_.send(_loc4_);
      ...
      {
         var _loc4_:IConnection = this.var_50.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_215);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1444)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_190);
         }
         if(param1.type == Event.CLOSE && !this.var_2645)
         {
            _loc2_ = this.var_159.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2645 = true;
         var _loc2_:String = this.var_159.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_159.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1443);
         ...
         var _loc9_:IConnection = this.var_50.getHabboMainConnection(null);
