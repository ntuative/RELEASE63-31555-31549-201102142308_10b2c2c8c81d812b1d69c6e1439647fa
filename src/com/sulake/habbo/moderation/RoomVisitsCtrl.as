package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_939:Array = [];
      
      private static var var_1780:int = 200;
      ...
      {
         this.var_751 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
         ...
         this.var_55 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_939.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_751.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_939.length < var_1780)
         {
            ...
            param1.width = this.var_751.width;
            param1.height = this.var_751.height;
            var_939.push(param1);
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_55.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_55.scrollableRegion.height > this.var_55.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_55.width += 17;
            }
         }
         else if(_loc4_)
         {
