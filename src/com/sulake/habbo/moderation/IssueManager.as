package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1184:String = "issue_bundle_open";
      
      public static const const_680:String = "issue_bundle_my";
      
      public static const const_1053:String = "issue_bundle_picked";
      
      public static const const_1436:int = 15000;
       
      
      private var var_62:ModerationManager;
      
      private var var_577:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_577 = new IssueBrowser(this,this.var_62.windowManager,this.var_62.assets);
         this.var_1117 = [];
         this.var_1116 = [];
         this.var_902 = new Map();
         this.var_2315 = parseInt(this.var_62.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1680 = new Timer(const_1436,0);
         this.var_1680.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1680.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1117 = this.var_1117.concat(_loc4_.getIssueIds());
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_390 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1116 = this.var_1116.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_577 == null || !this.var_577.isOpen())
         {
            this.var_62.soundManager.playSound(HabboSoundTypesEnum.const_1112);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1575)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_680);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1116.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2315);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_902.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_902.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
         ...
         for each(_loc4_ in this.var_98)
         {
            switch(param1)
            {
               case const_1184:
                  ...
                  break;
               case const_680:
                  if(_loc4_.state == IssueMessageData.const_390 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_902.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_902.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_390 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_902.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
