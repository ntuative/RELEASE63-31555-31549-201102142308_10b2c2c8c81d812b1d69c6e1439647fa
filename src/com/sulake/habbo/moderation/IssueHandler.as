package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_158:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_510:UserInfoCtrl;
      
      private var var_1180:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_47,this.onResized);
         }
         ...
         var _loc3_:IssueMessageData = this.var_158.getHighestPriorityIssue();
         this.var_510 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         this.var_1180 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         ...
         if(this.var_158.reportedUserId > 0)
         {
            this.var_1180.load(_loc4_,this.var_158.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_158.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_158.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_62 != null && this.var_62.issueManager != null && this.var_158 != null)
         {
            this.var_62.issueManager.removeHandler(this.var_158.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_158.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_158.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_158.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.releaseBundle(this.var_158.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_158.getHighestPriorityIssue().issueId;
         this.var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_62,WindowTracker.const_1185,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_158.getHighestPriorityIssue();
            this.var_510 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
