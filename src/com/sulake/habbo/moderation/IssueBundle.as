package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_756:IssueMessageData = null;
      
      private var var_755:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2155 = param2.pickerUserId;
         this.var_2557 = param2.pickerUserName;
         this.var_1260 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1169 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1170;
         }
         if(this.var_756 == null || param1.timeStamp < this.var_756.timeStamp)
         {
            this.var_756 = param1;
         }
         if(this.var_755 == null || param1.priority > this.var_755.timeStamp)
         {
            this.var_755 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1169 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1170;
            }
            if(this.var_756 == _loc2_)
            {
               this.var_756 = null;
            }
            if(this.var_755 == _loc2_)
            {
               this.var_755 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_755;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_756;
         if(_loc2_ == null)
         {
