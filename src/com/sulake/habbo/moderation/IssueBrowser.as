package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1979:String = "my_issues";
      
      private const const_1977:String = "open_issues";
      
      private const const_1978:String = "picked_issues";
      
      private const const_1991:String = "closed_issues";
      ...
      private var var_1725:IIssueBrowserView;
      
      private var var_1723:IIssueBrowserView;
      
      private var var_1724:PickedIssuesView;
      ...
      private function method_11() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_253 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_253.numTabItems)
            {
               _loc5_ = this.var_253.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_253 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_253 == null || this.var_253.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_253.selector.getSelectableByName("open_issues");
         this.var_253.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_351 == _loc2_)
         {
            return;
         }
         ...
         this.var_351.view.width = this.var_253.container.width;
         this.var_351.view.height = this.var_253.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1979:
               ...
               {
                  this.var_1725 = new MyIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1725;
            case this.const_1977:
               if(this.var_1723 == null)
               {
                  this.var_1723 = new OpenIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1723;
            case this.const_1978:
               if(this.var_1724 == null)
               {
                  this.var_1724 = new PickedIssuesView(this.issueManager,this,this.var_253.container);
               }
