package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_808:Array = [];
      
      private static var var_1502:int = 1000;
      
      private static var var_809:Array = [];
      
      private static var var_1501:int = 200;
      ...
      private var var_1499:IMessageComposer;
      ...
      private var var_656:IWindowContainer;
      ...
      {
         this.var_656 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_655 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         this.var_474 = new Timer(1000,1);
         ...
         this.var_55 = IItemListWindow(this._frame.findChildByName("chatline_list"));
         this._frame.procedure = this.onWindow;
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_33.connection.send(this.var_1499);
      ...
      {
         var _loc1_:* = null;
         this.var_55.autoArrangeItems = false;
         for each(_loc1_ in this.var_115)
         {
            this.populateRoomChat(_loc1_);
         }
         this.var_55.autoArrangeItems = true;
      }
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.addHeaderLineToList(_loc2_,this.var_55);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            this.populateChatline(this.var_55,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_808.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_655.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_808.length < var_1502)
         {
            ...
            param1.width = this.var_655.width;
            param1.height = this.var_655.height;
            var_808.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1500[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1247.getValue(param2.chatterName))
            {
               this.var_1247.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1247.getValue(_loc2_);
      ...
      {
         if(param1.type != WindowEvent.const_47 || param2 != this._frame)
         {
            return;
         }
         this.var_474.reset();
      ...
      private function refreshListDims() : void
      {
         ...
         var _loc2_:* = null;
         this.var_55.autoArrangeItems = false;
         var _loc3_:int = this.var_55.numListItems;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = IWindowContainer(this.var_55.getListItemAt(_loc4_));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_55.parent);
         var _loc2_:IWindow = _loc1_.getChildByName("scroller") as IWindow;
         var _loc3_:* = this.var_55.scrollableRegion.height > this.var_55.height;
         if(_loc2_.visible)
         {
            if(_loc3_)
            {
