package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         return WindowTracker.const_1524;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.messageTemplates[this.var_1019.selection];
         if(_loc3_ != null)
         {
            this.var_587 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModMessageMessageComposer(this.var_1359,this.var_481.text,this.var_1360));
         this.dispose();
      }
