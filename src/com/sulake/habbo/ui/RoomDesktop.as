package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1079:IRoomWidgetFactory = null;
      
      private var var_396:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_449:IAvatarRenderManager = null;
      ...
      private var var_1078:IHabboHelp = null;
      ...
      private var var_2438:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_402,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_515,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_835,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_180 = param1;
         this.var_180.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         this.var_180.events.addEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
      }
      
      public function set layout(param1:XML) : void
      {
         this.var_198.setLayout(param1,this._windowManager);
         if(this.var_180 != null)
         {
            this.var_198.toolbarSize = this.var_180.size;
            this.var_198.toolbarOrientation = this.var_180.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_489.length)
            {
               _loc6_ = this.var_489.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_402,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_515,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_835,this.onRoomContentLoaded);
         }
         ...
         {
            this.var_180.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_736 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_286 != null && this.var_31.state == RoomSessionEvent.const_256)
         {
            this.var_1752 = !this.var_286.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1079.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_198.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!this.var_489.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,this.var_198.roomViewRect);
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_782:
               ...
               if(this.var_873 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_373)
                  {
                     this.var_873.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_292:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_459:
               ...
               break;
            case RoomEngineObjectEvent.const_839:
               if(!this.var_31.isRoomController && !this.var_396.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_125:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1027,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_436:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_120,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_455:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1173,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_679);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_847);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_763);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_704);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_285,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2438);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_285:
               _loc3_ = "null";
               break;
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1753) / 1000);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_489.length)
         {
            _loc2_ = this.var_489.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_15 != null && this.var_31 != null && this.var_1752 && this.var_1754)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_346);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_566:
               ...
               this.var_218 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_348,WindowStyle.const_727,WindowParam.const_95) as IToolTipWindow;
               this.var_218.setParamFlag(WindowParam.const_30,false);
