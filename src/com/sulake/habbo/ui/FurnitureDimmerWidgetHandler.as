package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_873,RoomWidgetDimmerSavePresetMessage.const_702,RoomWidgetDimmerChangeStateMessage.CHANGE_STATE,RoomWidgetDimmerPreviewMessage.const_167];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_532);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_532:
            ...
            case RoomEngineDimmerStateEvent.const_61:
               ...
               _loc5_ = new RoomWidgetDimmerStateUpdateEvent(_loc4_.state,_loc4_.method_4,_loc4_.effectId,_loc4_.color,_loc4_.brightness);
               this._container.events.dispatchEvent(_loc5_);
               break;
            case RoomEngineObjectEvent.const_105:
               this._container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_814));
         }
      }
