   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_149,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_135,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_153,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_149,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_135,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_153,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_582.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_582.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_806);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_770);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_316);
         _loc1_.push(RoomWidgetFurniActionMessage.const_632);
         _loc1_.push(RoomWidgetFurniActionMessage.const_822);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_851);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_886);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_870);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1360);
         _loc1_.push(RoomWidgetPetCommandMessage.const_428);
         _loc1_.push(RoomWidgetPetCommandMessage.const_821);
         _loc1_.push(RoomWidgetUserActionMessage.const_473);
         _loc1_.push(RoomWidgetUserActionMessage.const_375);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_798);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_425)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_375 || param1.type == RoomWidgetUserActionMessage.const_473 || param1.type == RoomWidgetUserActionMessage.const_548)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_473:
               ...
               break;
            case RoomWidgetUserActionMessage.const_806:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1126,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_890:
               ...
               break;
            case RoomWidgetUserActionMessage.const_770:
            ...
            case RoomWidgetFurniActionMessage.const_822:
               ...
               break;
            case RoomWidgetUserActionMessage.const_375:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_851:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_886:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_870:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_728);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_389);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_989);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1150);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_373)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1190)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_501);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_172)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_220)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc32_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_687);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1491;
                  if(!_loc27_)
                  {
                  ...
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1094;
                  }
                  if(!_loc29_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1106;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1362);
               }
               else
               {
               ...
               _loc19_ = _loc11_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_53,_loc19_);
               if(_loc20_ != null)
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_582.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_582.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
      ...
      private function onPetCommands(param1:RoomSessionPetCommandsUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            _loc2_ = new RoomWidgetPetCommandsUpdateEvent(param1.petId,param1.method_3,param1.enabledCommands);
