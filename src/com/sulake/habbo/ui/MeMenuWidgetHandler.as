   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_812,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_815,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_180 != null)
            {
               this.var_180.events.removeEventListener(HabboToolbarEvent.const_63,this.onHabboToolbarEvent);
               this.var_180.events.removeEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_463,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_121,this.onHelpTutorialEvent);
            }
            if(this._container.catalog != null)
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_65,this.onCreditBalance);
            }
         }
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_812,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_815,this.onHabboClubSubscriptionChanged);
         }
         this.var_180 = this._container.toolbar;
         if(this.var_180 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_463,this.onHelpTutorialEvent);
         ...
         if(this._container.catalog != null)
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_65,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1358)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc4_.setDirection(AvatarSetType.const_45,3);
                  _loc1_ = _loc4_.getCroppedImage(AvatarSetType.const_45);
                  _loc4_.dispose();
               }
               this.var_1358 = _loc2_;
               this.var_1676 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1676;
            }
         }
         if(this.var_180 != null)
         {
            ...
            this.var_180.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_718);
         _loc1_.push(RoomWidgetDanceMessage.const_804);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_619);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_885);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_394);
         _loc1_.push(RoomWidgetStopEffectMessage.const_606);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1612);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1097);
         _loc1_.push(RoomWidgetToolbarMessage.const_608);
         _loc1_.push(RoomWidgetToolbarMessage.const_857);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_380);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1531);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_965);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_807);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_866);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_726);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1373);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_794);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_724);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_809);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_381);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_866:
               ...
               break;
            case RoomWidgetWaveMessage.const_718:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_804:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_619:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_692:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_394:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1104)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_191,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_885:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_972:
                        this._catalog.openCatalogPage(CatalogPageName.const_1475,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1085:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_313);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1429:
            ...
            case RoomWidgetStopEffectMessage.const_606:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1097:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_807:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_608:
               ...
               if(this.var_180)
               {
                  this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                  ...
                  {
                     this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_65,this._catalog.getPurse().credits));
                  }
               }
               ...
               break;
            case RoomWidgetToolbarMessage.const_857:
               ...
               {
                  this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_474,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_380:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_540));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_726:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_794:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_337,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_724:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_337,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_809:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_437));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_381:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_766));
               break;
            default:
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_65,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_463:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_453));
         }
      }
