package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_275:Map = null;
      
      private var var_539:Map = null;
      
      private var var_1497:Map = null;
      ...
      private var var_654:Point = null;
      
      private var var_448:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1005 = [];
         this.var_448 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         if(this.var_380 != null)
         {
            ...
            {
               _loc2_ = this.var_380.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_275 != null)
         {
            ...
            {
               _loc2_ = this.var_275.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1005)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_820,RoomWidgetChatSelectAvatarMessage.const_756];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_820:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_756:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_275.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_380.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_539.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_539.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_222)
                                    {
                                       this.var_275.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_380.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1006 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1006);
            }
            if(this.var_654 == null)
            {
               ...
               this.var_448.y = 0;
               this.var_448.z = 0;
               this.var_654 = _loc4_.getScreenPoint(this.var_448);
               this.var_1006 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_448.x = 0;
            this.var_448.y = 0;
            this.var_448.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_448);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_654.x || _loc8_.y != this.var_654.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_654,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_275)
         {
            _loc2_ = this.var_275.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_380)
         {
            _loc2_ = this.var_380.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1005.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_539.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1497.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1497.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_275)
            {
               this.var_275.add(_loc3_,param2);
            }
         }
      }
   }
