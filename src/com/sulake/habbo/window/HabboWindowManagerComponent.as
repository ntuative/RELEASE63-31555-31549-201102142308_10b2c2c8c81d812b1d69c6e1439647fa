package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1245:uint = 1;
      ...
      private var var_850:IWindowRenderer;
      
      private var var_851:ISkinContainer;
      
      private var var_332:Array;
      
      private var var_1304:IEventDispatcher;
      
      private var var_1062:Boolean = false;
      
      private var var_1609:ProfilerOutput;
      
      private var var_1305:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_851 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_850 = new WindowRenderer(this.var_851);
         this.var_190 = new Array(const_409);
         ...
         {
            this.var_190[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_850,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_190[const_1245];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_383,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1366,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1609)
            {
               this.var_1609 = new ProfilerOutput(context,this,this.var_850);
            }
            this.var_1609.profiler = _loc3_;
            this.var_1305 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1305);
            this.var_1306 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1306);
            this.var_1062 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_190)
            {
               ...
               {
                  IDisposable(this.var_190.pop()).dispose();
               }
            }
            this.var_190 = null;
            if(this.var_332)
      ...
      {
         var _loc3_:Dictionary = this.var_332[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_332[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_851.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_190[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_190[param2].getDesktopWindow();
      ...
      {
         return this.var_190[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_190[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_190[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_373.length > 0)
         {
            this.var_1304.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_409 - 1;
            while(_loc2_ >= 0)
            {
               this.var_190[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1062)
         ...
         this.var_1304.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_409)
         {
            this.var_190[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1062)
         {
         ...
         if(WindowContext.var_373.length > 0)
         {
            WindowContext.var_373.flush();
         }
         this.var_1304.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1392,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1388,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1526,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_552,
            "style":WindowStyle.const_173,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
