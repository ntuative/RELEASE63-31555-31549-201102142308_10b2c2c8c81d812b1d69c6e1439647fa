package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1905:int = "F".charCodeAt(0);
      
      public static const const_1780:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_880 = param1.gender;
         this.var_678 = param1.online;
         this.var_1718 = param1.followingAllowed && param1.online;
         this.var_568 = param1.figure;
         this.var_1880 = param1.motto;
         this.var_1602 = param1.lastAccess;
         this.var_1445 = param1.categoryId;
         this.var_1601 = param1.realName;
