package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_366:int = 100;
      ...
      {
         if(this.var_950 >= this.getPageCount())
         {
            this.var_950 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_221.length / const_366);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_950 * const_366;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_950 + 1) * const_366,this.var_221.length);
      }
