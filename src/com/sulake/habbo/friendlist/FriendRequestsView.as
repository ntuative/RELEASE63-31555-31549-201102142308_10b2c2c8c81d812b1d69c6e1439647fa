package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1682:String = "no_reqs_info";
      ...
      private var var_1717:IContainerButtonWindow;
      
      private var var_1716:IContainerButtonWindow;
      ...
      {
         this.var_1717 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1716 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1716.procedure = this.onDismissAllButtonClick;
         this.var_1717.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_367)
         {
         ...
         else if(param1.state == FriendRequest.const_967)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_55.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_55.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_367;
         ...
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_43,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_367 && _loc4_.state != FriendRequest.const_370)
            {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_367 && _loc4_.state != FriendRequest.const_370)
            {
               ...
               _loc4_.state = FriendRequest.const_367;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_43,_loc4_.requestId));
               }
            }
         }
         this._friendList.send(_loc3_);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1717,_loc1_);
         this.setEnabled(this.var_1716,_loc1_);
      }
