package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1679:String = "noconvinfo";
      
      private static const const_1678:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1343:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1343 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_974 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_243 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1343.prepare(this.var_974);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_995,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1055,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_615,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_738,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_615,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_738,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1342 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1342.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1658 == -1 ? 0 : int(this.var_17.height - this.var_1658);
         var _loc4_:int = this.var_1660 == -1 ? 0 : int(this.var_17.width - this.var_1660);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_243.y = Util.getLowestPoint(this.var_17.content);
         this.var_243.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_975,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_615,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_995,false);
         ...
         this.var_1658 = this.var_17.height;
         this.var_1660 = this.var_17.width;
