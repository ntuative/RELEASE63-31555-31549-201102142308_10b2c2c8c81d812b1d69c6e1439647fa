package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_163:String = "face";
      ...
      private var var_998:IAvatarRenderManager;
      
      private var var_757:ISessionDataManager;
      
      private var var_2569:FriendListLookAndFeel;
      
      private var var_399:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1825:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_998)
         {
            this.var_998.release(new IIDAvatarRenderManager());
            this.var_998 = null;
         }
         if(this.var_834)
         {
            this.var_834.release(new IIDHabboNotifications());
            this.var_834 = null;
         }
         if(this.var_180)
         {
         ...
         if(this.var_757)
         {
            this.var_757.release(new IIDSessionDataManager());
            this.var_757 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1825 = new OpenedToWebPopup(this);
         }
         this.var_1825.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_101,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_359.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_180.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_317,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_998.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_164.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_164.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_998 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_180 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_834 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1068,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_360,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_95.addFriend(new Friend(_loc4_));
         }
         this.var_399 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_613)
         {
         ...
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_360);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_399.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_333));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_399.findTab(FriendListTab.const_97).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_399.findTab(FriendListTab.const_97);
      ...
      {
         var _loc2_:FriendListTab = this.var_399.findTab(FriendListTab.const_97);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_757 || !this.var_359)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_757.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_359.vipLimit;
         }
         else if(this.var_757.hasUserRight("fuse_extended_buddylist"))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_163) as IBitmapWrapperWindow;
