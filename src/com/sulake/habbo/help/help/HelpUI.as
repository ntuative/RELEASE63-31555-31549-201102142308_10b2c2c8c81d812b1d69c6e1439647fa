package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_317 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102142302));
         this.var_180 = param5;
         this.var_103 = new Map();
         this.var_103.add(HabboHelpViewEnum.const_1566,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_194,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_468,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_319,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_240,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_347,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_657,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_242,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_103.add(HabboHelpViewEnum.const_1058,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_103.add(HabboHelpViewEnum.const_1034,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_729,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_103.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_103.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_446.length == 0 || param1 != this.var_317)
            {
               this.var_446.push(this.var_317);
            }
         }
         this.var_317 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_317);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_242:
               this.showUI(HabboHelpViewEnum.const_242);
               break;
            case CallForHelpResultEnum.const_1056:
               this.showUI(HabboHelpViewEnum.const_1034);
               break;
            case CallForHelpResultEnum.const_1140:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_103.getValue(HabboHelpViewEnum.const_194) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_562));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_103.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_103.getValue(this.var_317);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1996 = this._window.width - _loc4_.width;
         this.var_1997 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1997;
         this._window.width = _loc1_.width + this.var_1996;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_446.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_317 == HabboHelpViewEnum.const_194)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_317 == HabboHelpViewEnum.const_194 || this.var_446.length == 0)
         {
            return;
         }
         if(this.var_318 == null)
