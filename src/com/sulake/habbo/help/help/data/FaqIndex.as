package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      public function FaqIndex()
      {
         ...
         this.var_673 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_675 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_673.hasItem(param1))
         {
            this.var_673.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_673.hasItem(param1))
         {
            return this.var_673.getItem(param1);
         }
         if(this.var_675.hasItem(param1))
         {
