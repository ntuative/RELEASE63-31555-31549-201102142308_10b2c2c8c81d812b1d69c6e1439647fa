package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_361:String = "TUI_NAME_VIEW";
      
      public static const const_382:String = "TUI_CLOTHES_VIEW";
      
      public static const const_537:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_540,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_437,this.onTaskDoneEvent);
      ...
      {
         return this.var_1000 && this.var_1001 && this.var_1243;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            ...
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_540,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_437,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_562:
               this.var_1243 = true;
               if(this.var_41 != null && this.var_41.id == const_537)
               {
                  this.showView(const_89);
               }
               break;
            case HabboHelpTutorialEvent.const_540:
               if(this.var_41 != null && this.var_41.id == const_382)
               {
                  this.var_1492 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_437:
               if(this.var_1492)
               {
                  this.var_1492 = false;
                  this.showView(const_89);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_1996 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_1997;
         this._window.width = _loc2_.width + this.var_1996;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_41 != null && (this.var_41.id == const_361 || this.var_41.id == const_89))
         {
            this.showView(const_89);
         }
      }
      ...
      {
         this.var_1000 = true;
         if(this.var_41 != null && (this.var_41.id == const_382 || this.var_41.id == const_89))
         {
            this.showView(const_89);
         }
      }
