package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1252:uint = 13232628;
      
      private static var var_1514:uint = 11129827;
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_41.width;
            this._window.content.height = this.var_41.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1515 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_659)
         {
            this.var_659 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_659)
            {
               return;
            }
            this._window.content.addChild(this.var_659);
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_792:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_788:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_984 || param1 == ChangeUserNameResultMessageEvent.var_985)
         {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_89);
         }
      }
