package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_130.push(new ActorIsOnFurni());
         this.var_130.push(new FurnisHaveAvatars());
         this.var_130.push(new StatesMatch());
         this.var_130.push(new TimeElapsedMore());
         this.var_130.push(new TimeElapsedLess());
         this.var_130.push(new UserCountIn());
         this.var_130.push(new ActorIsInTeam());
         this.var_130.push(new HasStackedFurnis());
         this.var_130.push(new StuffTypeMatches());
      }
