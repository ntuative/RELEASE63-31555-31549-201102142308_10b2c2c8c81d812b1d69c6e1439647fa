package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_1021:SliderWindowController;
      
      private var var_1057:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1021.getValue());
         _loc2_.push(this.var_1057.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_89 = param2;
         this.var_1021 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_1021.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_1021.setValue(1);
         this.var_1057 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1057.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_1057.setValue(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1021.setValue(_loc3_);
         this.var_1057.setValue(_loc4_);
      }
