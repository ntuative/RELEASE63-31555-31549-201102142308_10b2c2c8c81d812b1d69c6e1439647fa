package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1621:TriggerConfs;
      
      private var var_1619:ActionTypes;
      
      private var var_1620:ConditionTypes;
      
      private var var_240:Dictionary;
      
      private var var_60:Triggerable;
      
      private var var_689:RoomObjectHightLighter;
      
      private var var_181:UserDefinedRoomEventsHelp;
      
      private var var_1072:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1621 = new TriggerConfs();
         this.var_1619 = new ActionTypes();
         this.var_1620 = new ConditionTypes();
         this.var_240 = new Dictionary();
         super();
         this.var_89 = param1;
         this.var_689 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_240[param1])
         {
            delete this.var_240[param1];
            this.var_689.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_60.furniLimit)
         {
            this.var_240[param1] = param2;
            this.var_689.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1072 = new SliderWindowController(this.var_89,IWindowContainer(this.find(this.var_88,"delay_slider_container")),this.var_89.assets,0,20,1);
         this.var_1072.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1072.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_689.hideAll(this.var_240);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1072.getValue()) : 0;
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1621);
         this.refreshConfigureElement(this.var_1619);
         this.refreshConfigureElement(this.var_1620);
