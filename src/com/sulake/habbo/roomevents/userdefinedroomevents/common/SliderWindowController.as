package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1144:Number = 1.0;
      
      private var var_593:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1144,param1);
         this.var_932 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_932);
         }
      ...
      {
         return int(this.var_1488 * (Number(param1 - this._minValue) / (this.var_1144 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1488 * (this.var_1144 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_931)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_183)
            {
               this.var_931 = false;
            }
         }
         if(!this.var_931 || param1.type != WindowEvent.const_334)
         {
            return;
         }
         if(this.var_593 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_593) * this.var_593;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_593 != 0)
            {
               _loc3_ = this.var_932 + this.var_593;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_653 != null)
            {
               ...
               this.var_1488 = _loc1_.width - _loc2_.width;
            }
         }
