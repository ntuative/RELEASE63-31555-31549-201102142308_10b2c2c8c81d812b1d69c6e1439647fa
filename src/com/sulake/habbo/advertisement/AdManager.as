package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1002:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2003 = this._config.getKey("interstitial.enabled","HabboNavigatorCom_roc_create_room_xml") == "true";
         this.var_2004 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2001 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1496 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_203 != null && this.var_203.running)
         {
            this.var_203.reset();
            return false;
         }
         ...
         if(this.var_1496 > 0 && this.var_1494 >= this.var_1496)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1004;
         if(_loc1_ > this.var_2004)
         {
            ++this.var_1494;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1245 = _loc2_.imageUrl;
         this.var_2002 = _loc2_.clickUrl;
         this.var_1004 = getTimer();
         if(this.var_1245 != "")
         {
            _loc3_ = this.var_1245;
            ...
            {
               this.var_203 = new Timer(this.var_2001,1);
               this.var_203.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_203.running)
            {
               this.var_203.reset();
            }
            this.var_203.start();
            _loc4_ = new URLRequest(this.var_1245);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_469,0,0,param1.bitmapData,this.var_2002));
            this.var_1004 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_423));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1495 = _loc2_.clickUrl;
         if(this.var_1244 != "" && this.var_1495 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_488,0,0,_loc4_,this.var_1495,this.var_1002,this.var_1003));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1002 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
