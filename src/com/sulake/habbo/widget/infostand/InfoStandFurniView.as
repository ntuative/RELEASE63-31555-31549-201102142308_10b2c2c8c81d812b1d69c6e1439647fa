package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_903 = this.var_193.findChildByTag("catalog");
         if(this.var_903 != null)
         {
            this.var_903.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_51.addListItem(this.var_903);
            }
            this.var_903.visible = param1;
         }
         else
         {
            this.var_51.removeListItem(this.var_903);
         }
      }
   }
}
