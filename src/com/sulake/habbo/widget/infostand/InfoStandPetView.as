package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_193:IBorderWindow;
      
      private var var_65:IItemListWindow;
      
      private var var_51:IItemListWindow;
      
      private var var_194:PetCommandTool;
      
      private var _petData:Map;
      
      private var var_508:int;
      
      private const const_1963:int = 152;
      
      private const const_1971:int = 16;
      
      private const const_1262:int = 4;
      
      private const const_1970:uint = 14342874;
      
      private const const_1962:uint = 3815994;
      
      private const const_1961:uint = 2085362;
      
      private const const_1972:uint = 39616;
      
      private const const_1967:uint = 10513106;
      
      private const const_1966:uint = 8734654;
      
      private const const_1960:uint = 9094430;
      
      private const const_1964:uint = 6200576;
      
      private const const_1968:String = "happiness";
      
      private const const_1965:String = "experience";
      
      private const const_1969:String = "energy";
      ...
      {
         if(this.var_51 == null || this.var_193 == null || this.var_65 == null)
         {
            return;
         }
         ...
         this.var_193.height = this.var_51.height + 20;
         this._window.width = Math.max(this.var_193.width,this.var_65.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_193.width < this.var_65.width)
         {
            this.var_193.x = this._window.width - this.var_193.width;
            this.var_65.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1968,param1.nutrition,param1.nutritionMax,this.const_1972,this.const_1961);
         this.updateStateElement(this.const_1965,param1.experience,param1.experienceMax,this.const_1966,this.const_1967);
         this.updateStateElement(this.const_1969,param1.energy,param1.energyMax,this.const_1964,this.const_1960);
         ...
         this.updateWindow();
         this.var_508 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_194 && this.var_194.isVisible() && param1.isOwnPet)
         {
            this.var_194.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_194.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1963,this.const_1971,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1970);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1962);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1262,_loc7_.width - 2,_loc7_.height - 2 - this.const_1262);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1262);
      ...
      private function openTrainView() : void
      {
         if(this.var_194 == null)
         {
            this.var_194 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_508) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_194.showWindow(true);
            this.var_194.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_193 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_193 != null)
         {
            this.var_51 = this.var_193.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_193.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_193.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_193.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_193.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_194 && this.var_194.getPetId() == this.var_508)
               {
                  this.var_194.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1389,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_458,this._widget.petData.ownerId);
