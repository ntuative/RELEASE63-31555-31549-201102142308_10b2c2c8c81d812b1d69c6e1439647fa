package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_428:IFrameWindow;
      ...
      private const const_1986:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_361 = new Timer(this.const_1986);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1176.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_508);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1176.getValue(this.var_508) as CommandConfiguration;
      ...
      {
         this.var_1176.remove(param1);
         this.var_1176.add(param1,param2);
         if(param1 != this.var_508)
         {
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_821,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_38.setParamFlag(WindowParam.const_95,true);
         this.var_38.context.getDesktopWindow().addEventListener(WindowEvent.const_47,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_428 == null)
         {
            ...
            this.var_428 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_428 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_428.x = 200;
            this.var_428.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_375,this.var_508));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_428,this.var_508,this.var_1842 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_428,this.var_508,this.var_1842 + " " + _loc5_);
