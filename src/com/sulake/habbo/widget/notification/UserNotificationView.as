package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1652:String = "text_title";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_618)
            {
               while(this.var_618.length > 0)
               {
                  this.var_618.pop().dispose();
               }
               this.var_618 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_1652).caption = title;
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_618.indexOf(param1);
            if(_loc2_ > -1)
            {
               this.var_618.splice(_loc2_,1);
            }
            param1.dispose();
         }
      }
