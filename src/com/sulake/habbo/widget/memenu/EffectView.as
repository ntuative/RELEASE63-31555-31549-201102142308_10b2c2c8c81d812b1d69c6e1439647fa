package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_982:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_195 = new Timer(1000);
         this.var_195.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_195.stop();
            this.var_195.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_195 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_980 != null)
         {
            if(this.var_183.isActive)
            {
               ...
               this.var_980.width = _loc2_ * this.var_310;
            }
            else
            {
               this.var_980.width = 0;
               this.var_195.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_981.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_981.text;
            if(this.var_183.isActive)
            {
               ...
               this.var_981.text = _loc1_;
            }
            else
            {
               this.var_981.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(this.var_183.isInUse)
            {
               this.method_5("effect_hilite","memenu_fx_pause");
            }
            else
            {
               this.method_5("effect_hilite","memenu_fx_play");
            }
            this.var_982 = this._window.findChildByName("effect_hilite");
            this.var_982.visible = false;
         }
         this.var_981 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_980 = this._window.findChildByName("loader_bar");
         if(this.var_980 != null)
         {
            this.var_310 = this.var_980.width;
            this.var_195.start();
            this.onUpdate();
         }
      ...
      private function method_5(param1:String, param2:String) : void
      {
