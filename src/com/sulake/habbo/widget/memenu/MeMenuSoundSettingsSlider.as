package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_997:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_997.volume);
      }
      ...
      {
         if(param1.type != WindowEvent.const_334)
         {
            return;
         }
         this.var_997.saveVolume(this.getValue(param2.x),false);
      }
