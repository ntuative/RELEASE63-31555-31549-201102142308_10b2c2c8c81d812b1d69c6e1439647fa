package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1990:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         if(this._window == null || this.name_1 == null || param1 == null)
         {
            return;
         }
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               this.name_1.addListItem(_loc5_);
            }
            _loc6_++;
         }
         _loc6_ = 0;
         while(_loc6_ < this.name_1.numListItems)
         {
            _loc5_ = this.name_1.getListItemAt(_loc6_) as IWindowContainer;
            if(_loc5_ != null)
            {
               _loc5_.width = this.name_1.width;
            }
            _loc6_++;
         }
         this.var_983 = -1;
      ...
      private function createWindow() : void
      {
         ...
         this.name_1 = this._window.findChildByName("item_list") as IItemListWindow;
      ...
      {
         var _loc2_:* = null;
         if(this.name_1 == null || param1 < 0 || param1 > this.name_1.numListItems || param1 == this.var_983)
         {
            return;
         }
         if(this.var_983 != -1)
         {
            _loc2_ = this.name_1.getListItemAt(this.var_983) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_983 % 2) ? uint(this.const_1703) : uint(this.const_1702);
            }
         }
         _loc2_ = this.name_1.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_1990;
            this.var_983 = param1;
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this._items == null || this.name_1 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         ...
         this.populate(this._items,this.var_1927);
      }
