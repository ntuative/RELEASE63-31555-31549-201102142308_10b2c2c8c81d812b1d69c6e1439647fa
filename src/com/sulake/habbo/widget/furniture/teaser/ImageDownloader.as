package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class ImageDownloader implements IDisposable
   {
      ...
      private var var_40:AssetLoaderStruct;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_40)
         {
            this.var_40.removeEventListener(AssetLoaderEvent.const_28,this.onImageReady);
         }
         this.var_40 = null;
         this._disposed = true;
      }
      ...
      public function downloadImage(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_40 = this._assets.loadAssetFromFile(param2,_loc3_,"image/png");
            this.var_40.addEventListener(AssetLoaderEvent.const_28,this.onImageReady);
         }
      }
