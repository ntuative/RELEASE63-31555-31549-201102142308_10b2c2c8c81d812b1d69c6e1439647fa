package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1328:int = 18;
      ...
      private var var_176:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_782 = false;
         this._widget = param1;
         this.var_176 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_176.state = RoomChatHistoryPulldown.const_239;
         ...
         this.var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_978,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_176.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_239);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_176.state == RoomChatHistoryPulldown.const_378 || this.var_176.state == RoomChatHistoryPulldown.const_502;
      }
      ...
      {
         if(!this.var_422 && !this.var_1615)
         {
            this.var_422 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_176.state = RoomChatHistoryPulldown.const_378;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_46 != null)
         {
            ...
            if(param2)
            {
               this.var_46.scrollV = this.var_609;
            }
         }
         if(this.var_176 != null)
         {
            this.var_176.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_423 > 0 && param2)
         {
            if(this.var_1816)
            {
               if(Math.abs(param1 - this.var_423) <= const_1143)
               {
                  return;
               }
               this.var_1816 = false;
            ...
            if(this.var_422)
            {
               ...
               _loc5_ = (param1 - this.var_423) / this.var_46.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_46.scrollV < 1 - const_1328 / this.var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1815)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_609 = this.var_46.scrollV;
         }
         if(this.var_46 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_609 - this.var_46.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
