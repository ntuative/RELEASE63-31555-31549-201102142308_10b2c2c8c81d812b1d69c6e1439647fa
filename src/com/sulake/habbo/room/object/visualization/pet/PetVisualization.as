package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_600:PetVisualizationData = null;
      ...
      private const const_1231:int = 3;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_463.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_463.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_600 = param1 as PetVisualizationData;
         createSprites(this.const_1231);
         var _loc2_:BitmapData = (this.var_600.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this._isSleeping = param1.getNumber(RoomObjectVariableEnum.const_349) > 0;
            this.var_1283 = param1.getString(RoomObjectVariableEnum.const_241);
            this.var_257 = param1.getString(RoomObjectVariableEnum.const_350);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_889);
            this.var_1565 = param1.getNumber(RoomObjectVariableEnum.const_281);
            this.var_1282 = param1.getNumber(RoomObjectVariableEnum.const_856);
            this.var_2066 = param1.getNumber(RoomObjectVariableEnum.const_840);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_443 != param1.getUpdateID() || this.var_1618 != param2.updateId)
         {
            ...
            if(_loc5_ != this.var_1775 || param3)
            {
               this.var_1775 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_57.setDirectionAngle(AvatarSetType.const_45,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_463.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_600.getAvatar(this.var_568,param1,this);
            if(_loc3_ != null)
            {
               this.var_463.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_599 = null;
         _loc2_ = getSprite(this.const_1657);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_187 || this.var_57 == null)
         {
            if(_loc6_ != var_187)
            {
               var_187 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_846 || this.var_1045 > 0 || this.var_1564;
         this._experienceData.alpha = 0;
         if(this.var_1282 > 0)
         {
            _loc12_ = param2 - this.var_1282;
            if(_loc12_ < AvatarAction.const_945)
            {
               this._experienceData.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this._experienceData.setExperience(this.var_2066);
               this.var_1045 = this.const_1945;
            }
            else
            {
               this.var_1282 = 0;
         ...
         if(_loc10_ || _loc11_)
         {
            ...
            _loc13_ = getSprite(this.const_934);
            if(_loc13_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1283 != null && this.var_1283 != "")
         {
            param1.appendAction(AvatarAction.const_299,this.var_1283);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1231;
