package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_597:int = 1;
      
      private static const const_945:int = 1000;
      
      private static const const_1333:String = "pet_experience_bubble_png";
      
      private static const const_1332:int = 0;
      ...
      private var var_299:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_299 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_299.commonAssets != null)
         {
            _loc3_ = this.var_299.commonAssets.getAssetByName(const_1333) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_163)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_350);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_241);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_349) > 0;
            this.var_1565 = _loc3_.getNumber(RoomObjectVariableEnum.const_281);
            this.var_1282 = _loc3_.getNumber(RoomObjectVariableEnum.const_856);
            this.var_2066 = _loc3_.getNumber(RoomObjectVariableEnum.const_840);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1841)
            {
               this.var_1841 = _loc6_;
               this.var_2598 = this.var_1841.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1282 > 0)
            {
               _loc2_ = param1 - this.var_1282;
               if(_loc2_ < const_945)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_945 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_257 = param1;
            _loc3_ = this.var_299.getAnimationForPosture(var_187,param1);
            this.setAnimationForIndex(const_1332,_loc3_);
         }
         if(param2 != this.var_1283)
         {
            this.var_1283 = param2;
            _loc3_ = this.var_299.getAnimationForGesture(var_187,param2);
      ...
      {
         return super.getAdditionalSpriteCount() + const_597;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2598);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_597)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_597))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_546.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_546[param2];
               if(_loc4_ == 1)
               {
