package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1313:String = "shore";
       
      
      private var var_1804:Boolean = true;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1168)
            {
      ...
      {
         if(this.var_2553 == param1 && this.var_2554 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1313)
            {
               this.var_1805 = _loc2_;
               this.var_2553 = param1;
               this.var_2554 = _direction;
               return this.var_1805;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1168.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1804 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_421.length)
         {
            if(this.var_421[_loc5_] == true)
            {
               this.var_1804 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_608[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_608[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_501 == 0 || this.var_607 == 0)
         {
            ...
            this.var_501 = _loc2_.getNumber(RoomObjectVariableEnum.const_276);
            this.var_607 = _loc2_.getNumber(RoomObjectVariableEnum.const_362);
         }
         this.var_421 = [];
         this.var_608 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_501 * 2 + this.var_607 * 2)
         {
            this.var_421.push(false);
            this.var_608.push(ShoreMaskCreatorUtility.const_76);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_67,getSize(param3),this.var_421,this.var_608,assetCollection);
      }
