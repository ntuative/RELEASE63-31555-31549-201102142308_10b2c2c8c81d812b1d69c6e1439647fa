package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_1933:int = 0;
      ...
      private var var_116:Map = null;
      
      private var var_418:int = -1;
      
      private var var_1533:Boolean = false;
      
      private var var_1262:Array = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_116 != null)
         {
            ...
            {
               _loc2_ = this.var_116.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(this.var_1262 != null && this.var_1262.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_418;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_116.add(param1,_loc6_);
         var _loc11_:int = _loc6_.frameCount;
         if(_loc11_ > this.var_418)
         {
            this.var_418 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_116.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_116.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
