package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_205:int = 3;
      
      public static const const_244:int = 4;
      
      public static const const_254:int = 5;
      
      public static const REPEAT_MODE_RANDOM:int = 6;
      
      public static const const_1492:int = const_342;
      ...
      public static const const_289:int = const_117;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_367[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      public function createColumn(param1:int, param2:int, param3:Array, param4:int = 1) : Boolean
      {
         ...
         var _loc6_:PlaneMaterialCellColumn = this.var_367[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_367[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_662,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_629,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_367.length)
         {
            _loc11_ = this.var_367[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1884 == const_117)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_629);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_629,this.var_30.width,this.var_629);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_367.length == 1)
         {
            _loc4_ = this.var_367[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
