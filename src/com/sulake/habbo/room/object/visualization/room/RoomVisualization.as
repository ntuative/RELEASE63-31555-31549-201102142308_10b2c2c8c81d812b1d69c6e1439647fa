package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1428:int = 16777215;
      
      public static const const_1378:int = 13421772;
      
      private static const const_949:int = 16777215;
      
      private static const const_952:int = 13421772;
      
      private static const const_950:int = 10066329;
      
      private static const const_951:int = 10066329;
      
      public static const const_1377:int = 16777215;
      
      public static const const_1376:int = 13421772;
      
      public static const const_1516:int = 10066329;
      ...
      private var var_516:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2623:String = null;
      
      private var var_1189:uint = 16777215;
      
      private var var_2622:int = 255;
      
      private var var_2624:int = 255;
      
      private var var_2626:int = 255;
      ...
      private const const_1987:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_516 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1168);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1156);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_162)
            {
               ...
               {
                  _loc13_.color = const_951;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_949;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_952;
               }
               else
               {
                  _loc13_.color = const_950;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_291)
            {
               ...
               {
                  _loc13_.color = const_1376;
               }
               else
               {
                  _loc13_.color = const_1516;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1368)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_108,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_291)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1987 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_364.length)
            {
               _loc10_ = this.var_623[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_364[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_96)
               {
                  if(this.var_1867)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2626 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2624 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2622 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1618)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1311 || _loc3_.y != this.var_2136 || _loc3_.z != this.var_2140 || param1.scale != this.var_2139))
            {
               this.var_1311 = _loc3_.x;
               this.var_2136 = _loc3_.y;
               this.var_2140 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_163 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_976);
            if(_loc3_ != this.var_2623)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2623 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_772));
            if(_loc4_ != this.var_1189)
            {
               this.var_1189 = _loc4_;
               this.var_2626 = this.var_1189 & 255;
               this.var_2624 = this.var_1189 >> 8 & 255;
               this.var_2622 = this.var_1189 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1121));
            if(_loc5_ != this.var_1867)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_163 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_616);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_760);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_736);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_845));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_813));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_825));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_364;
         if(this.var_364.length == 0)
         {
            _loc6_ = this.var_121;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_364.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_364.push(_loc12_);
                        this.var_623.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1868;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_516.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_516.maskCount)
         {
            _loc10_ = this.var_516.getMaskType(_loc8_);
            _loc11_ = this.var_516.getMaskLocation(_loc8_);
            _loc12_ = this.var_516.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_121.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_108 || _loc3_.type == RoomPlane.const_96)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        _loc14_ = Vector3d.method_1(_loc11_,_loc3_.location);
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_108 || _loc3_.type == RoomPlane.const_96 && _loc12_ == RoomPlaneBitmapMaskData.const_260)
                              {
