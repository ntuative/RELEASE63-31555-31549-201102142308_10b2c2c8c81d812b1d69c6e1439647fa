package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_770:IGraphicAssetCollection;
      
      private var var_1506:XMLList;
      ...
      private var var_918:Boolean = true;
      ...
      private var var_1133:Point = null;
      ...
      {
         if(param1 != this.var_917)
         {
            this.var_917 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1383 = this.var_42.getValue(this.var_917);
         }
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         this.var_1133.x = _loc3_.x;
         this.var_1133.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_42.getValue(this.var_917);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1731 = RoomObjectVariableEnum.const_1009;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1731 = RoomObjectVariableEnum.const_1115;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1134 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1134 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_42.getValue(this.var_917);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2417 && param3 == this.var_2416)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1134 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1134 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1731);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_470;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = this.var_770.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1133.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1133.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_408.indexOf(_loc10_) >= 0 && this.var_918)
            {
               param1 = this.var_408.indexOf(_loc10_);
               if(this.var_584[param1] != "")
               {
                  _loc9_ = this.var_770.getAsset(this.var_584[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_583[param1] != -1)
               {
                  param2.alpha = this.var_583[param1];
               }
               this.var_408.splice(param1,1);
               this.var_584.splice(param1,1);
               this.var_583.splice(param1,1);
      ...
      {
         this.var_918 = true;
         var _loc3_:int = this.var_408.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_408.push(param1);
            this.var_584.push(param2);
            this.var_583.push(-1);
         }
         else
         {
            this.var_584[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_408.push(param1);
            this.var_584.push("");
            this.var_583.push(param2);
         }
         else
         {
            this.var_583[_loc3_] = param2;
         }
      }
   }
}
