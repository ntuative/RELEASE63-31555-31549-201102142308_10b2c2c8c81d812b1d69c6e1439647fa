package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1738:int = 16777216;
      ...
      private var var_1699:int = 16777216;
      ...
      {
         var _loc1_:int = this.var_2768 * this.var_1700 + this.var_2767;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1699;
         this.var_1700 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1699 * param2);
      }
   }
}
