   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2103 = param1.extra;
            this.var_1053 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1053 > 0 && param1 >= this.var_1053)
         {
            this.var_1053 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1586,String(this.var_1586),this.var_2103);
