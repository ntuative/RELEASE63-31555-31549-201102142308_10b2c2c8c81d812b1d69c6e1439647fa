package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1690:int = 1;
      
      private static const const_943:int = 10;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null && _loc2_ == null)
         {
            if(param1.loc != null)
            {
               ...
               _loc5_ = Vector3d.method_1(param1.loc,_loc4_);
               if(_loc5_ != null)
               {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1837.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.method_1(object.getLocation(),this.var_1837).length == 0)
            {
               if(object.getState(0) != const_944)
               {
                  object.setState(const_944,0);
               }
            }
         }
      }
