package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1082:uint = 16777215;
      
      private var var_1636:int = 255;
      
      private var var_1081:int = 0;
      
      private var var_1639:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1168,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_772,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_845,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_813,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_825,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1081)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1638;
            if(_loc2_ - this.var_1081 >= this.var_1639)
            {
               _loc3_ = this.var_1082;
               _loc4_ = this.var_1636;
               this.var_1081 = 0;
            }
            else
            {
               _loc7_ = this.var_1325 >> 16 & 255;
               _loc8_ = this.var_1325 >> 8 & 255;
               _loc9_ = this.var_1325 & 255;
               _loc10_ = this.var_1082 >> 16 & 255;
               _loc11_ = this.var_1082 >> 8 & 255;
               _loc12_ = this.var_1082 & 255;
               _loc13_ = (_loc2_ - this.var_1081) / this.var_1639;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1637 + (this.var_1636 - this.var_1637) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_772,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_655:
               param2.setString(RoomObjectVariableEnum.const_760,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_739:
               param2.setString(RoomObjectVariableEnum.const_616,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_623:
               param2.setString(RoomObjectVariableEnum.const_736,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_426:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_260)
               {
                  _loc5_ = "null";
               }
               this.var_516.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_860:
               _loc4_ = this.var_516.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_516.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_976,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1191:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1036:
               param2.setNumber(RoomObjectVariableEnum.const_813,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_825,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1325 = this._color;
         this.var_1637 = this.var_1638;
         this.var_1082 = _loc3_;
         this.var_1636 = _loc4_;
         this.var_1081 = getTimer();
         this.var_1639 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_499,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1608,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1617,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1485,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_499,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_165)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_162 || _loc13_ == RoomPlaneData.const_291)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
