package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1070:String = "group_badge";
      
      public static const const_1452:String = "normal_badge";
       
      
      private const const_1688:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1688 + param1;
         ...
         switch(param2)
         {
            case const_1452:
               ...
               {
                  _loc5_ = this.var_164.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1070:
               if(this.var_164 != null)
               {
                  if(this.var_164 != null)
                  {
                     _loc5_ = this.var_164.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1688,"");
