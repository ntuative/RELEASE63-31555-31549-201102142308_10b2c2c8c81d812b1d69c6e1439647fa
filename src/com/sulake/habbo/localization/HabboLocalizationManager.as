package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1614:Dictionary;
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2128 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1613 = (param2 & 0) > 0;
         if(!this.var_1613)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1613)
            {
               if("HabboNavigatorCom_roc_create_room_xml" == this.var_164.getKey("use.default.localizations","HabboNavigatorCom_roc_create_room_xml"))
               {
      ...
      public function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(this.var_164.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_164.getKey("external.override.texts.txt");
      ...
      {
         this.var_1614[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1614[param1];
      }
      ...
      {
         return this.var_2128[Math.max(0,param1 - 1)];
      }
   }
}
