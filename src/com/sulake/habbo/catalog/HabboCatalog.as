package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_341:ICatalogNavigator;
      
      private var var_97:Purse;
      ...
      private var var_2240:Boolean = true;
      
      private var var_2241:Boolean = true;
      
      private var var_1652:Boolean = false;
      
      private var var_2239:GiftWrappingConfiguration;
      
      private var var_1095:ClubGiftController;
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_97.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_97.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_211 == null)
            {
               this.var_211 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_211.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_341.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_164.getKey("client.credits.embed.enabled","HabboNavigatorCom_roc_create_room_xml") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_164.getKey("link.format.credits","/credits");
      ...
      public function getSellablePetBreeds(param1:int) : Array
      {
         var _loc2_:Array = this.var_712.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_97.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_97.getActivityPointsForType(Purse.const_168)));
         var _loc1_:int = 0;
         if(!this.var_97.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_97.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_97.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_97.clubPeriods));
         }
      ...
      {
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_729)
         {
            if(!this.var_396.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_180 != null && _loc2_)
         {
            this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         this.method_5("layoutBackground",_loc2_.content as BitmapData);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1652 = param1.session.isPrivateRoom;
               if(this.var_90 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1095 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_341.buildCatalogIndex(_loc2_);
         if(this.var_713 && this.var_713 != "")
         {
            this.var_341.openPage(this.var_713);
            this.var_713 = "";
            this.var_889 = -1;
         }
         else if(this.var_889 > -1)
         {
            this.var_341.openPageById(this.var_889,this.var_1651);
            this.var_889 = -1;
            this.var_1651 = -1;
            this.var_713 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_97.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2240 && this.var_571 != null)
         {
            this.var_571.playSound(HabboSoundTypesEnum.const_1088);
         }
         this.var_2240 = false;
         if(this.var_295 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_65,this.var_97.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_97.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2241 && this.var_571 != null)
         {
            this.var_571.playSound(HabboSoundTypesEnum.const_1187);
         }
         this.var_2241 = false;
         if(this.var_295 != null)
         {
         ...
         if(_loc2_.type == Purse.const_168)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_97.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_97.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_97.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_97.isVIP = _loc2_.isVIP;
         this.var_97.pastClubDays = _loc2_.pastClubDays;
         this.var_97.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1095.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2239 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_712.remove(_loc2_.petType);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_712.add(_loc2_.petType,_loc3_.slice());
            this.var_296.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.petType,_loc3_.slice()));
         }
      }
      
      private function method_5(param1:String, param2:BitmapData) : void
      {
