package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1276:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1336:XML;
      
      private static var var_1337:XML;
       
      
      private var var_1647:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2763:IWindowContainer;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_55);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_55);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1647 == 4294967295)
            {
               this.var_1647 = _loc1_.color;
            }
            _loc1_.color = const_1276;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1614;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1437;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_55);
            }
         }
         if(this.var_55 != null)
         {
            this.var_55.visible = true;
            this.var_55.height = this.var_55.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_55);
            }
         }
         if(this.var_55 != null)
         {
            this.var_55.height = 0;
      ...
      {
         this.var_55 = navigator.catalog.windowManager.buildFromXML(var_1337) as IItemListWindow;
         if(this.var_55 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1336) as IWindowContainer;
         }
         else
         {
         ...
         this.method_5("iconBackgroundBitmap","icon_bg_img",true,color);
         this.initIcon();
         if(!disabled)
         {
      ...
      private function method_5(param1:String, param2:String, param3:Boolean = true, param4:uint = 0) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc8_:int = 0;
