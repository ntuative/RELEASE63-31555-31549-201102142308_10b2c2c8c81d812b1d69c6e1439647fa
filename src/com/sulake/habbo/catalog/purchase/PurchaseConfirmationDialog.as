package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_550:IWindowContainer;
      
      private var var_328:int = -1;
      
      private const const_1943:int = 10;
      ...
      private const const_1942:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1546 = _loc1_.stuffTypes;
            this.var_665 = _loc1_.boxTypes;
            this.var_664 = _loc1_.ribbonTypes;
            this.var_1037 = this.var_1546[0];
            this.var_327 = this.var_665[0];
            this.var_326 = this.var_664[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_326 < 0)
         {
            this.var_326 = this.var_664.length - 1;
         }
         if(this.var_326 > this.var_664.length - 1)
         {
            this.var_326 = 0;
         }
         if(this.var_327 < 0)
         {
            this.var_327 = this.var_665.length - 1;
         }
         if(this.var_327 > this.var_665.length - 1)
         {
            this.var_327 = 0;
         }
         var _loc1_:int = this.var_665[this.var_327] * 1000 + this.var_664[this.var_326];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1037,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1269 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1546;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1037);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_665[this.var_327]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_664[this.var_326]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_91,this.var_1270,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_91.offerId,this.var_1270);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_100:
               ...
               if(this.var_2040 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_221)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1943)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2040 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_372:
      ...
      {
         if(this.var_236 == null || !this.var_236.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_236.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_236 == null)
         {
            this.var_236 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_550 == null)
         {
            this.var_550 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_550.procedure = this.suggestionsEventHandler;
         }
         if(this.var_236 == null || this.var_550 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_236.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_550.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_236.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1037;
               }
            }
            _loc4_++;
         }
