package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_355);
                     break;
                  case "ctlg_text_7":
            ...
            case "club1":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openCatalogPage(CatalogPageName.const_191,true);
               }
               break;
            case "club_buy":
               switch(_loc4_)
      ...
      protected function initLocalizables() : void
      {
         ...
         while(_loc1_ < page.localization.imageCount)
         {
            ...
            if(_loc2_ != "")
            {
               ...
               {
                  _loc6_ = _loc3_;
                  this.var_935[_loc6_] = _loc2_;
                  if(page.viewer.catalog.assets.hasAsset(_loc6_))
                  {
                     this.method_5(_loc2_,_loc6_);
                  }
                  else
                  {
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         var _loc5_:String = this.var_935[param1];
      ...
      private function onCatalogImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = this.var_935[_loc3_];
            this.method_5(_loc4_,_loc3_);
         }
      }
   }
}
