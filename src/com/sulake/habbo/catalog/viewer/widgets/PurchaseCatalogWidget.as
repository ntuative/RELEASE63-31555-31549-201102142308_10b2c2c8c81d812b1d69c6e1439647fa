package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2538:XML;
      
      private var var_2540:XML;
      
      private var var_949:IWindowContainer;
      
      private var var_605:IButtonWindow;
      
      private var var_2807:IButtonWindow;
      ...
      private var var_2775:ITextWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_625,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2541 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2538 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2540 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_625,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_878:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2541) as IWindowContainer;
               break;
            case Offer.const_984:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2538) as IWindowContainer;
               break;
            case Offer.const_1174:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2540) as IWindowContainer;
               break;
            default:
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_949);
         ...
         this.var_1795 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1796 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1794 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2775 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_605 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_605 != null)
         {
            if(this.var_1409 != null)
            {
               this.var_605.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1409);
            }
            else
            {
               this.var_605.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1409);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1795 != null)
         {
            ...
            this.var_1795.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_91.activityPointType == Purse.const_168 ? "pixels" : "activitypoints";
         if(this.var_1796 != null)
         {
            ...
            this.var_1796.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_2539 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_91 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_91,page.pageId,this.var_2539);
         }
      }
   }
}
