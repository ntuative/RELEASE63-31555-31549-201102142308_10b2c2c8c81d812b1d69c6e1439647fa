package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1957:int = 10;
      
      private var var_677:Array;
      
      private var var_1303:MarketPlaceOfferData;
      
      private var name_1:IItemListWindow;
      ...
      public function displayMainView() : void
      {
         ...
         this.name_1 = window.findChildByName("offer_list") as IItemListWindow;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_677 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_677 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_677));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_562)
         {
            ...
            this.var_562 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_562)
         {
            return;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1056 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1056));
            ++this.var_1056;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this.name_1 || !this.var_562 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_562.clone() as IWindowContainer;
         ...
         this.name_1.addListItem(_loc2_);
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!this.marketPlace || !param2 || !this.name_1 || !this._offers)
         {
            return;
         }
         var _loc3_:* = [];
         if(this.name_1.groupListItemsWithID(param1,_loc3_))
         {
      ...
      private function onOfferListEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc3_ = this.name_1.getListItemIndex(param1.window.parent);
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_677.length)
         {
            _loc4_ = this.var_677[_loc6_.selection];
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1303.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
