   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1149.add(MarketPlaceOfferState.const_963,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1149.add(MarketPlaceOfferState.const_451,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1149.add(MarketPlaceOfferState.const_186,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            _loc4_ = this.var_1149.getValue(_loc11_.status);
            if(_loc4_)
            {
      ...
      public function displayMainView() : void
      {
         ...
         this.name_1 = window.findChildByName("item_list") as IItemListWindow;
      }
