package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1198 = new PrizeViewer();
         this.var_775 = this.recycler.getPrizeTable();
         if(this.var_775 == null)
         {
            return false;
         }
         this.name_1 = _window.findChildByName("itemList") as IItemListWindow;
         ...
         this.var_1894 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_775.length > 0 && this.var_775[0].prizes.length > 0)
         {
            this.select(this.var_775[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_775.length)
         {
            this.createLevelItem(this.var_775[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1894) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1893) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1198.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
