package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1761:Point;
      
      private var var_492:IItemGridWindow;
      
      private var var_1391:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_927 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1140 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1761 = new Point(this.var_84.x,this.var_84.y);
         this.var_492 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1391 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1762 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_927.text = _loc4_;
         this.var_1140.text = _loc5_;
         this.var_927.height = this.var_927.textHeight + 5;
         this.var_1140.y = this.var_927.y + this.var_927.height;
         this.var_1140.height = Math.max(130,this.var_1140.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_464:
                  _loc6_ = this.var_1762.clone();
                  if(this.var_492 != null)
                  {
                     this.var_492.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_492,this.var_1391,this.var_1893);
                     this.var_492.scrollV = 0;
                  }
                  break;
               case Offer.const_471:
               case Offer.const_555:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_248:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_45,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_299,AvatarAction.const_543);
                              _loc16_.appendAction(AvatarAction.const_298,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2453)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2453 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1761.x;
            this.var_84.y = this.var_1761.y;
            if(param3 != null)
            {
