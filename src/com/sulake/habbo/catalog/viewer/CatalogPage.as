package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1654:String = "ctlg_";
       
      
      protected var var_1986:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1198:ICatalogViewer;
      ...
      private var var_524:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1215:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_524 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1216);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1216);
      }
      ...
      {
         var _loc2_:String = const_1654 + param1;
         ...
         this.var_1986 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1986) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1554:
               if(this.var_1215 == null)
               {
                  this.var_1215 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1215);
               }
               break;
            case CatalogWidgetEnum.const_1600:
               this.var_47.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1494:
            ...
            case CatalogWidgetEnum.const_1627:
               ...
               break;
            case CatalogWidgetEnum.const_1395:
            ...
            case CatalogWidgetEnum.const_1626:
               ...
               break;
            case CatalogWidgetEnum.const_1439:
               this.var_47.push(new ColourGridCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1621:
            ...
            case CatalogWidgetEnum.const_1570:
               ...
               break;
            case CatalogWidgetEnum.const_1426:
               this.var_47.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1533:
               this.var_47.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1497:
            ...
            case CatalogWidgetEnum.const_1563:
               ...
               break;
            case CatalogWidgetEnum.const_1416:
               this.var_47.push(new TextInputCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1352:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_524.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_524 != null)
         {
            return this.var_524.dispatchEvent(param1);
         }
         return false;
      }
   }
