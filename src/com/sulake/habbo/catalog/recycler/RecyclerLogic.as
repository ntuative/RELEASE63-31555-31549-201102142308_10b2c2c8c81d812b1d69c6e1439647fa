package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_177:int = 5;
      
      private static const const_900:int = 0;
      
      private static const const_406:int = 1;
      
      private static const const_901:int = 2;
      ...
      {
         return this.var_557 != const_900;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1572 != RecyclerStatusMessageEvent.const_991;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_557 == const_406;
      }
      ...
      {
         this.var_557 = const_901;
         this.var_104 = new Array(const_177);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_177)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_557 = const_900;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1523:
               this.var_557 = const_406;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_991:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1584:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1025:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1598:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_104.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_177)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_104.length < const_177)
         {
            return false;
         }
         var _loc1_:int = 0;
