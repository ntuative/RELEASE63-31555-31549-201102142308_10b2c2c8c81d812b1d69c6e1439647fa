package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_897:uint = 11;
      ...
      private var var_188:IHabboFriendList;
      
      private var var_1020:IHabboWindowManager;
      ...
      private var var_542:FramerateTracker = null;
      
      private var var_233:LatencyTracker = null;
      
      private var var_541:LagWarningLogger = null;
      
      private var var_543:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_542 = new FramerateTracker();
         this.var_233 = new LatencyTracker();
         this.var_541 = new LagWarningLogger();
         this.var_543 = new ToolbarClickTracker(this);
         this.var_1256 = new Array(const_897);
         var _loc4_:int = 0;
         while(_loc4_ < const_897)
         {
            this.var_1256[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1493,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1537,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1546,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_740,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_985,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1020)
            {
               this.var_1020.release(new IIDHabboWindowManager());
               this.var_1020 = null;
            }
            if(this.var_286)
            {
            ...
            if(this.var_188)
            {
               ...
               {
                  Component(this.var_188).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_188).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_188).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_188).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_188).events.removeEventListener(HabboFriendListTrackingEvent.const_333,this.onFriendlistTrackingEvent);
               }
               this.var_188.release(new IIDHabboFriendList());
               this.var_188 = null;
            }
            if(this.var_181)
            {
            ...
            if(this.var_180)
            {
               ...
               {
                  this.var_180.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_164)
         {
            if(this.var_233 != null)
            {
               this.var_233.configuration = this.var_164;
            }
            if(this.var_234 != null)
            {
               this.var_234.configuration = this.var_164;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1611);
            if(this.var_164)
            {
               if(this.var_541 != null)
               {
                  this.var_541.configure(this.var_164);
               }
               if(this.var_542 != null)
               {
                  this.var_542.configure(this.var_164);
               }
               if(this.var_543 != null)
               {
                  this.var_543.configure(this.var_164);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_865,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_262,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_193,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_190,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_215,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_246,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_792,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_529,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_541 != null)
            {
               this.var_541.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_792)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1435);
         }
         else if(param1.type == HabboHotelViewEvent.const_529)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1379);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_865:
               this.trackLoginStep(HabboLoginTrackingStep.const_1496,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_262:
               this.trackLoginStep(HabboLoginTrackingStep.const_262);
               break;
            ...
            case HabboCommunicationEvent.const_215:
               ...
               this.trackLoginStep(HabboLoginTrackingStep.const_215);
               if(this.var_233 != null)
               {
                  this.var_233.init();
               }
      ...
      {
         this.var_1020 = IHabboWindowManager(param2);
         if(this.var_1020)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_164)
            {
               if(this.var_164.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1256)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1061);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1061,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_188 = param2 as IHabboFriendList;
         Component(this.var_188).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_188).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_188).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_188).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_188).events.addEventListener(HabboFriendListTrackingEvent.const_333,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2021)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1518);
            this.var_2021 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_985,String(_loc2_.guestRoomId));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_286.events.addEventListener(AdEvent.const_488,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_180 = param2 as IHabboToolbar;
         this.var_180.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_543)
         {
            this.var_543.track(param1.iconName);
         }
      }
      ...
      {
         this.var_541.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_453 > -1 && _loc2_ < this.var_453)
         {
            ++this.var_1517;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1517);
         }
         if(this.var_453 > -1 && _loc2_ - this.var_453 > 15000)
         {
            ++this.var_1516;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1516);
         }
         this.var_453 = _loc2_;
         if(this.var_234 != null)
         {
            this.var_234.update(param1,this.var_453);
         }
         if(this.var_233 != null)
         {
            this.var_233.update(param1,this.var_453);
         }
         if(this.var_542 != null)
         {
            this.var_542.trackUpdate(param1,this,this.var_453);
         }
         if(this.var_541 != null)
         {
            this.var_541.update(this.var_453);
         }
      }
   }
}
