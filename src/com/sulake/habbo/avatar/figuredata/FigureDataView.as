package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            this.var_1179 = _loc4_.content as BitmapData;
         }
         if(this._window != null)
         {
            this.var_414 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_414 && this.var_1179)
         {
            this.var_414.bitmap = new BitmapData(this.var_414.width,this.var_414.height,true,16777215);
            this.var_414.bitmap.copyPixels(this.var_1179,this.var_1179.rect,new Point(0,this.var_414.height - this.var_1179.height - 8));
            this.var_414.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
