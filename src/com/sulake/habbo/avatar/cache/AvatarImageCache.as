package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1676:int = 60000;
      ...
      private var var_414:AvatarImageBodyPartContainer;
      
      private var var_1335:String;
      
      private var var_109:AvatarImagePartContainer;
      
      private var var_2221:Point;
      
      private var var_711:String;
      
      private var var_170:BitmapData;
      ...
      private var var_2220:ByteArray;
      
      private var var_2219:ImageData;
      
      private var var_966:PaletteMap;
      
      private var var_886:Array;
      
      private var var_885:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_711 == GeometryType.const_1176 && param1 == GeometryType.const_1090 || this.var_711 == GeometryType.const_1090 && param1 == GeometryType.const_1176)
         {
            this.var_711 = param1;
            this.var_83 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_340.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_629)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1348.getFigure(),_loc5_,this.var_711,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_414 = _loc10_.getImageContainer(_loc4_);
         if(this.var_414 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_414 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_340);
            if(this.var_414 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_414,_loc4_);
         }
         this.var_414.offset = _loc8_;
         return this.var_414;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_83)
         {
            this.var_83 = this._structure.getCanvas(this._scale,this.var_711);
            if(!this.var_83)
            {
               return null;
            }
            this.var_2221 = new Point(0,this.var_83.height - int(this.var_83.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_838 || _loc10_ == AvatarAction.const_368;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1335 = this.var_109.bodyPartId;
               this.var_169 = this.var_109.partType;
               this.var_1645 = this.var_109.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_109.flippedPartType != this.var_169)
                     {
                        this.var_169 = this.var_109.flippedPartType;
                     }
                  }
               }
               this.var_1334 = this._scale + "_" + this.var_109.action.assetPartDefinition + "_" + this.var_169 + "_" + this.var_1645 + "_" + _loc5_ + "_" + this._frame;
               this.var_404 = this._assets.getAssetByName(this.var_1334) as BitmapDataAsset;
               if(this.var_404 == null)
               {
                  this.var_1334 = this._scale + "_std_" + this.var_169 + "_" + this.var_1645 + "_" + _loc5_ + "_0";
                  this.var_404 = this._assets.getAssetByName(this.var_1334) as BitmapDataAsset;
               }
               if(!(!this.var_404 || !this.var_404.content))
               {
                  ...
                  {
                     this.var_966 = this._structure.renderManager.paletteManager.getPalette(this.var_109.paletteMapId);
                     if(this.var_966 != null)
                     {
                        this.var_884 = this.var_404.content as BitmapData;
                        this.var_170 = new BitmapData(this.var_884.width,this.var_884.height);
                        this.var_2220 = this.var_966.colorize(this.var_884.getPixels(this.var_884.rect));
                        this.var_170.setPixels(this.var_170.rect,this.var_2220);
                     }
                     else
                     {
                        this.var_170 = (this.var_404.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1335 == AvatarBodyPartType.const_249 || this.var_1335 == AvatarBodyPartType.const_1601 || this.var_1335 == AvatarBodyPartType.const_1353) && this.var_109.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_170.colorTransform(this.var_170.rect,_loc18_);
                  }
                  else if(this.var_109.isColorable && this.var_109.color != null)
                  {
                     this.var_170.colorTransform(this.var_170.rect,this.var_109.color.colorTransform);
                  }
                  if(this.var_109.isBlendable)
                  {
                     this.var_170.colorTransform(this.var_170.rect,this.var_109.blendTransform);
                  }
                  this.var_885 = this.var_404.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2219 = new ImageData(this.var_170,this.var_885,_loc7_);
                  this.var_886.push(this.var_2219);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_886,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2221.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_53)
            {
         ...
         _loc8_ = this.var_886.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_886.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
