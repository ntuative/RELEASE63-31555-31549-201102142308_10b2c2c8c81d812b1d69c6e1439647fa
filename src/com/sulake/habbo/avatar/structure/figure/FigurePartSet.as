package com.sulake.habbo.avatar.structure.figure
{
   public class FigurePartSet implements IFigurePartSet
   {
      ...
      public function FigurePartSet(param1:XML, param2:String)
      {
         ...
         this.var_880 = String(param1.@gender);
         this.var_2035 = parseInt(param1.@club);
         this.var_1472 = Boolean(parseInt(param1.@colorable));
         this.var_2036 = Boolean(parseInt(param1.@selectable));
