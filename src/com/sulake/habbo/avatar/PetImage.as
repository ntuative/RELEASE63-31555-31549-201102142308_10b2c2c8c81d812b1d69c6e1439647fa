package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            if((this.var_86 == 6 || this.var_86 == 0) && param2 == 7)
            {
               param2 = this.var_86;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1448);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_578);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_578);
                  _loc20_ = this.var_86;
                  _loc21_ = 1;
                  switch(this.var_86)
                  {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_86 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_86 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_86 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_86 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_578);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_578);
                  _loc21_ = this.var_86;
                  _loc22_ = 1;
                  switch(this.var_86)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_86 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_86 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_86 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_86 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_484 = this.var_484 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_343:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1521:
                  case AvatarAction.const_1441:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_313.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_969);
         this.getCache().resetBodyPartCache(this.var_969);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1447 = this._structure.sortActions(this.var_313);
         ...
         {
            this.var_724 = this._structure.getCanvasOffsets(this.var_1447,this._scale,this.var_86);
         }
      }
      ...
      private function method_10() : void
      {
         ...
         for each(_loc1_ in this.var_1447)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_368)
               {
                  this.var_846 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_305)
               {
                  this.var_846 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1449 = _loc4_.id;
                     this.var_1891 = _loc4_.breed;
                     break;
                  }
               }
            }
