package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1595:Number = 1.0;
      
      private var var_1596:Number = 1.0;
      
      private var var_1597:Number = 1.0;
      ...
      {
         super();
         this.var_1834 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2576 = parseInt(_loc2_,16);
         this.var_2575 = parseInt(_loc3_,16);
         ...
         this.var_1870 = new ColorTransform(this.var_1595,this.var_1596,this.var_1597,this._alphaMultiplier);
         this.var_1173 = this.generatePaletteMapForGrayscale(this.var_2575,this.var_2576);
      }
      ...
      {
         return this.var_1173.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1173.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1173.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1173.getValue("alphas") as Array;
      }
