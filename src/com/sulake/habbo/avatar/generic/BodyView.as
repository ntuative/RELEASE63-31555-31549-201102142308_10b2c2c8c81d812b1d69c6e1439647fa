package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_602:String = "tab_boy";
      
      private const const_603:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_64.controller.gender)
         {
            case FigureData.const_78:
               activateTab(this.const_602);
               inactivateTab(this.const_603);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_603);
               inactivateTab(this.const_602);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_602:
                  var_64.controller.gender = FigureData.const_78;
