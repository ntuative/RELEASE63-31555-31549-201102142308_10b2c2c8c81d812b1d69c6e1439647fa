package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1217:IWindowContainer;
      
      public static var var_1476:IWindowContainer;
      
      public static var var_1938:int = 6710886;
      ...
      private var var_470:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1058 = [];
         this.var_1276 = [AvatarEditorFigureCategory.const_805,AvatarEditorFigureCategory.const_45,AvatarEditorFigureCategory.const_249,AvatarEditorFigureCategory.const_797,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_103];
         super();
         ...
         if(var_1217 == null)
         {
            ...
            var_1217 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1476 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1476 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_398 = new Timer(1000);
         this.var_398.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1276;
         }
         for each(_loc6_ in param4)
         {
            this.var_1058.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_398.stop();
            this.var_398.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_398 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1276);
         }
         if(param1.length != this.var_1058.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1058.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2117 = this.canChangeOutfit();
            this.var_398.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_470 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_470.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_470.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1058.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_470.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_470.numSelectables)
               {
                  this.var_470.getSelectableAt(_loc6_).x = this.var_470.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1276;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1603 == AvatarEditorSideCategory.const_103 || this.var_2116))
         {
         ...
         this.setViewToCategory(this.var_317);
      }
      ...
      {
         if(this.var_1603 == AvatarEditorSideCategory.const_103)
         {
            this.var_2116 = false;
            this.setSideContent(AvatarEditorSideCategory.const_852);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_103);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_852:
               break;
            case AvatarEditorSideCategory.const_476:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_476);
               break;
            case AvatarEditorSideCategory.const_103:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_103);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.invalidate();
         var _loc4_:IWindowContainer = this._controller.method_7(param1);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         this.var_317 = param1;
         this.var_470.setSelected(this.var_470.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_469)
         {
            ...
            this.var_469 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_469.procedure = this.stripClubDialogEventProc;
            this.var_469.center();
         }
         else
         {
