   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_252,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_237,_windowManager,_assetLibrary);
         }
         else
         {
