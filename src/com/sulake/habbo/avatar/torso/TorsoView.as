   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_211,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_169,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_268,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_64 && var_134 == "")
         {
            var_64.switchCategory(FigureData.const_169);
         }
      }
