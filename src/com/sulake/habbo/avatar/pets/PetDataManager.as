package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_161:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_429.getValue(_loc4_) == null)
               {
                  this.var_429.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_511 == null)
         {
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_511.length > 0)
         {
            _loc1_ = this.var_511.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_429.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc4_:PetData = this.var_429.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_429.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_429.getValue(key);
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.name_5.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1433.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_619.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_511.indexOf(param3) == -1)
                  {
                     this.var_511.push(param3);
                  }
               }
            }
         }
