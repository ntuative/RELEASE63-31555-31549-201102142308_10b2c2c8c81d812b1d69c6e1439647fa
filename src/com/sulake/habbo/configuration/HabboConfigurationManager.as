package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1307:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_580 = this.getKey("url_prefix");
         if(this.var_580 != null && this.var_580.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_580 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         if(!this.var_729)
         {
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_44,this.onConfigurationError);
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc4_ && _loc4_ != "")
         {
            ...
            _loc6_.addEventListener(AssetLoaderEvent.const_44,this.onConfigurationOverrideError);
         }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_580 = this.getKey("url.prefix");
         if(this.var_580.length > 0)
         {
            externalAccessDomain = this.var_580.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1127[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1127[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_580);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_1127[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1710.indexOf(param1) < 0 || param3)
         {
            this.var_1127[param1] = param2;
         }
         if(param3)
         {
            this.var_1710.push(param1);
         }
      }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1307);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1307,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
