package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1914:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_94.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1914 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_94)
         {
            this.var_63.controller.activateQuest(this.var_94);
         }
      }
      ...
      private function localize() : void
      {
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_63.code,this.var_94.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_63.code,"type_" + this.var_94.type.toLowerCase()].join(".");
         ...
         {
            _loc33_ = this.var_63.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_94.roomItemTypeName);
            if(_loc33_)
            {
               _loc34_ = this.var_63.controller.questEngine.roomEngine.getFurnitureImage(_loc33_.id,new Vector3d(90,0,0),64,this);
               this.var_1913 = _loc34_.id;
         ...
         {
            this.var_63.controller.questEngine.setImageFromAsset(_loc15_,this.var_94.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else
         {
            this.var_1913 = -1;
            QuestUtils.method_5(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         ...
         {
            case QuestStatusEnum.const_507:
               _loc16_.visible = true;
               break;
            case QuestStatusEnum.const_43:
            ...
            case QuestStatusEnum.const_186:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_620:
         ...
         this.var_63.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_94.rewardCurrencyAmount.toString());
         ...
         var _loc32_:String = "icon_" + this.var_63.code + "_reward_" + this.var_94.rewardCurrencyAmount;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_1913 == param1)
         {
            _loc3_ = this.find("quest.image") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               _loc3_.height = param2.height + 5;
               QuestUtils.method_5(_loc3_,param2,_loc3_.height);
               this.updateMargins();
            }
         }
      }
