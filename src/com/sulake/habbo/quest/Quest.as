package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1886 = param1.roomItemTypeName;
         this.var_1885 = param1.rewardCurrencyAmount;
         this.var_1624 = new Date();
         this.var_1624.setTime(param1.endDateTimeStamp);
         this.var_772 = param1.localizationCode;
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_63.code,this.var_772].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_199)
            {
               this.var_871.style = this.var_2170;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_199)
            {
               this.var_871.style = this.var_2171;
            }
         }
      }
