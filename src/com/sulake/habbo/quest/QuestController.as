package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_156.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      {
         if(this.var_617 != MODE_TABS)
         {
            this.var_617 = MODE_NO_TABS;
         }
         this.detachCampaign();
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1080.addChild(this.var_288.window);
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_156.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1080 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_148.getKeys())
         {
            ...
            if(!_loc2_)
            {
               _loc2_ = this.var_156.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_574) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_156.getQuestCampaign(param2.caption);
      }
   }
}
