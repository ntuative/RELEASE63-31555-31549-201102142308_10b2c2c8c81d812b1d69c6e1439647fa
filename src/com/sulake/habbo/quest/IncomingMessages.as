package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_156:HabboQuestEngine;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_760:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_156 = param1;
         this._communication = this.var_156.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_156.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_156.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_156.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaign(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length == 0)
         {
            ...
            this.var_760 = this.var_156.windowManager.alert("quest.nocampaigns.title","quest.nocampaigns.desc",0,this.onCloseAlert);
         }
         else
         {
            this.var_156.controller.openCampaigns(_loc2_.campaignCodes);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length > 0)
         {
            this.var_156.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_156.toolbar != null && this.var_156.configuration != null)
         {
            _loc2_ = this.var_156.configuration.getKey("questing.supportMultipleCampaigns","");
            _loc3_ = this.var_156.configuration.getKey("questing.defaultCampaign","");
            if(_loc3_ && _loc3_ != "" || _loc2_ && _loc2_ == "true")
            {
               this.var_156.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      {
         this.var_156.controller.close();
         this.var_156.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_160,HabboToolbarIconEnum.QUESTS));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_156.controller.updatePurse();
      }
