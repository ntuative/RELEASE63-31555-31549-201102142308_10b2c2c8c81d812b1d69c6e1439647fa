package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1440:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","HabboNavigatorCom_roc_create_room_xml") == "true")
         {
            this.var_1440 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_112,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1142,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_160,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_474,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1128,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1113,this.onHideWindowEvent);
         this._state = true;
