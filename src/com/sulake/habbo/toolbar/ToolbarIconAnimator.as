package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2759:Number;
      
      private var var_2760:Number;
      ...
      {
         if(this.var_1315 == true || this.var_864 == 0)
         {
            if(this.var_866.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_866.length)
               {
                  this._frame = 0;
                  ++this.var_864;
               }
      ...
      {
         return this.var_866.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1315 == false && this.var_864 == 1 && this.var_1586 != this._state;
      }
