package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_204:Boolean = true;
      
      private static const const_1244:Number = 25;
      
      private static const const_1242:Number = 90;
      
      private static const const_960:int = 50;
      
      private static const const_1349:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1473:ToolbarView;
      
      private var var_787:Timer;
      
      private var var_372:Array;
      
      private var name_1:Object;
      
      private var var_644:Object;
      ...
      {
         this.var_372 = new Array();
         this.name_1 = new Object();
         this.var_644 = new Object();
         this.var_642 = new Array();
         this.var_643 = new Array();
         super();
         this._windowManager = param1;
         this.var_1473 = param2;
         this.var_787 = new Timer(const_1244);
         this.var_787.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_372[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_960 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_960 || param1.desktop.height - param1.y < const_1349;
      }
      
      private function getItemObject(param1:String) : MenuAnimatorItem
      {
         return this.name_1[param1];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1473.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.name_1[_loc3_.menuId] = _loc3_;
            this.var_372.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1473.getIconLoc(param1.iconId);
      ...
      {
         return this.var_642[this.var_643.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_643[this.var_642.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            this.var_642.splice(_loc3_,1);
         }
         this.var_642.push(param1.name);
         this.var_643.push(param2);
         param1.addEventListener(WindowEvent.const_334,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_644[_loc3_] == null)
            {
               this.var_644[_loc3_] = new Array();
            }
            if(this.var_644[_loc3_].indexOf(param1) < 0)
            {
               this.var_644[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_372.indexOf(param1) > -1)
         {
            if(const_204)
            {
               this.name_1[param1].active = false;
               this.name_1[param1].window = null;
            }
            else
            {
               this.name_1[param1] = null;
               this.var_372.splice(this.var_372.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_642.length)
         {
            if(this.var_642[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_643[_loc2_];
               if(this.var_644[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_644[_loc3_].length)
                  {
                     this.repositionWindow(this.var_644[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_372.length)
         {
            _loc2_ = this.name_1[this.var_372[_loc7_]];
            if(_loc2_.active)
            {
