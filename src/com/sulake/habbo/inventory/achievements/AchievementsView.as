package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_55 = IItemListWindow(this._view.getChildByName("achievements_itemlist"));
         this.var_384 = new Timer(1000,1);
         this.var_384.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_135,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_384)
            {
               this.var_384.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_384.reset();
               this.var_384 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_384.running);
         this.var_1018[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1018[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_396.getBadgeImage(param2.badgeId);
            this.var_1018[param2.badgeId] = _loc4_;
         }
