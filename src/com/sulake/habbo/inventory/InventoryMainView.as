package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2777:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_180 != null && this.var_1195)
         {
            this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1195 = false;
         }
         this._controller.inventoryViewOpened(this.var_773);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_774 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_180 != null && this.var_1195)
            {
               this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1195 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_773);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.invalidate();
         var _loc3_:IWindowContainer = this._controller.method_7(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_774 == InventoryCategory.const_156)
            {
               this.toggleCategoryView(InventoryCategory.const_156);
            }
            else if(this.var_774 == InventoryCategory.const_79)
            {
