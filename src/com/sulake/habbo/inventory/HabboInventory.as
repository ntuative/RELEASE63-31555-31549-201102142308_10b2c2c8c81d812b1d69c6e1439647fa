package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1152:IRoomSession;
      ...
      private const const_1982:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_447,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_49.getValue(InventoryCategory.const_79));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_293));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_863));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_313));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_355));
      }
      ...
      {
         return PetsModel(this.var_49.getValue(InventoryCategory.const_156));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_49.getValue(InventoryCategory.const_344) as MarketplaceModel;
      }
      ...
      {
         return this.var_97.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_97.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_97.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_97.clubHasEverBeenMember;
      }
      ...
      {
         this.var_97.clubPeriods = param1;
         this.var_97.clubDays = param2;
         this.var_97.clubHasEverBeenMember = param3;
         this.var_97.isVIP = param4;
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_447,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_92:
               this.var_1152 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_447:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_396 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_180)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_180);
         this.var_49 = new Map();
         ...
         this.var_49.add(InventoryCategory.const_344,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_863,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_396);
         this.var_49.add(InventoryCategory.const_355,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_293,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_156,_loc8_);
         this.var_184 = true;
         if(this.var_2502)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_942.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_942.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_942.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_942.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1982);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_812));
      }
