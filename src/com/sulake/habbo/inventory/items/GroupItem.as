package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_646:BitmapData;
      ...
      protected var var_2738:BitmapData;
      
      private const const_1940:int = 8947848;
      
      private const const_1941:int = 13421772;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1392));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1967);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_1971 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2738;
               _loc5_.visible = true;
            }
            else
            {
