package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_907:uint = 4284532064;
      
      private static const const_908:uint = 2577770;
      
      public static const const_1096:int = 0;
      ...
      private var var_403:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_403 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_195)
            {
               this.var_195.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_195.stop();
               this.var_195 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1630 = this.createMinimizedWindow();
         }
         if(!this.var_2202)
         {
            return this.var_68;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_68)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_907) : uint(const_908);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_907) : uint(const_908);
            }
         ...
         if(this.var_68)
         {
            ...
            switch(this.var_22.state)
            {
               ...
               case TradingModel.const_387:
                  ...
                  break;
               case TradingModel.const_275:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_528:
                  _loc1_.disable();
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_195 = new Timer(1000,3);
            this.var_195.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_195.reset();
         this.var_195.repeatCount = 3;
         this.var_195.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_195.currentCount));
         if(this.var_195.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1118)
            {
            ...
            this.var_403.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_483);
            this.var_403.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_403.hideDelayed();
         }
      }
