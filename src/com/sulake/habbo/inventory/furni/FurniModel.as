package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1256:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_213,this.onObjectPlaced);
         this._catalog = param7;
         this.var_564 = new Timer(const_1256,1);
         this.var_564.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2134 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_213,this.onObjectPlaced);
               }
            ...
            {
               this.var_564.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_564.stop();
               this.var_564 = null;
            }
            if(this.var_191 != null)
            {
               this.var_191.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_191.stop();
               this.var_191 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_857 == null)
         {
            this.var_857 = this._windowManager.buildFromXML(this.var_2134) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_857.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_191 = new Timer(param1,1);
            this.var_191.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_191.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_344);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_472.add(const_42,new Array());
         this.var_472.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_374 || _loc3_.category == FurniCategory.const_379 || _loc3_.category == FurniCategory.const_328)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1309 && param1.type == RoomEngineObjectEvent.const_213)
         {
            this.var_1309 = false;
         }
      }
      ...
      {
         return this.var_472.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_472.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_472.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_793)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
