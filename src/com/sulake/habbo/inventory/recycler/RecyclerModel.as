package com.sulake.habbo.inventory.recycler
{
   ...
   public class RecyclerModel implements IInventoryModel
   {
      ...
      public function stopRecycler() : void
      {
         ...
         {
            _loc2_ = this.name_1.getKey(_loc1_);
      ...
      public function lockSelectedFurni() : int
      {
         ...
         if(this.name_1.getValue(_loc1_.id) == null)
         {
            this.name_1.add(_loc1_.id,_loc1_);
         }
         return _loc1_.id;
      }
      ...
      public function releaseFurni(param1:int) : Boolean
      {
         ...
         var _loc2_:IItem = this.name_1.getValue(param1);
         if(_loc2_ == null)
         {
            return false;
         }
         this._inventory.furniModel.removeLockFrom(param1);
         this.name_1.remove(param1);
         return true;
      }
      ...
      public function getOwnItemsInRecycler() : Array
      {
         ...
         {
            _loc1_.push(this.name_1.getKey(_loc2_));
            _loc2_++;
         }
         return _loc1_;
      }
