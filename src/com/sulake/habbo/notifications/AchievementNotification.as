package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1667:String = "badge_bg_001_png";
      
      private const const_1939:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1584 = param6;
         this.var_81 = param10;
         this._assets = param8;
         this.var_396 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_135,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2101 = this.var_81.getBadgeName(this.var_282);
         this.var_2096 = this.var_81.getBadgeDesc(this.var_282);
         this.var_2099 = this.var_81.getAchievementNameForFacebook(this.var_282,this.var_396.userName,this.var_396.realName,this.var_1292);
         this.var_2095 = this.var_81.getAchievementDescForFacebook(this.var_282,this.var_396.userName,this.var_396.realName,this.var_1292);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2098 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_81.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1902.toString());
         this.var_81.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1293.toString());
         this.var_81.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1293.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1584;
         var _loc17_:String = this.var_1584 == 0 ? "pixels" : "activitypoints";
         this.var_81.registerParameter(_loc16_,_loc17_,"" + this.var_2100);
         _loc15_.caption = this.var_81.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1667);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1939) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1293 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_282,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_282,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_282,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_81.registerParameter(param1,"badge_name",this.var_2101);
         this.var_81.registerParameter(param1,"badge_desc",this.var_2096);
         this.var_81.registerParameter(param1,"badge_name_fb",this.var_2099);
         this.var_81.registerParameter(param1,"badge_desc_fb",this.var_2095);
         this.var_81.registerParameter(param1,"level",this.var_1292.toString());
         this.var_81.registerParameter(param1,"name",this.var_396.userName);
         return this.var_81.registerParameter(param1,"realname",this.var_396.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_135,this.onBadgeImageReady);
            this.var_396 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_282)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1667);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_282,this._feedTitleFb,this.var_2098,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2097));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_282,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_282,"client.skip_post"));
               this.dispose();
               return;
         }
      }
