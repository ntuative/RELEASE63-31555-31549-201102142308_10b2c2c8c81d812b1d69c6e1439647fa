package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_630:int = 70;
      
      public static const const_525:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_502:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1727 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1727 = 15;
         }
         this.var_1728 = this._window.height;
         this.var_731 = 4;
         this.var_730 = 0;
         this._state = name_3;
         this.var_180 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_502:
               ...
               _loc2_ = Number(this.var_1131) / Number(this.var_407["time_fade_in"]);
               if(this.var_1131 > int(this.var_407["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_928:
               ...
               if(this.var_1382 > int(this.var_407["time_display"]) && !this.var_1729)
               {
                  this.startFadeOut();
               }
               break;
            case const_927:
               ...
               _loc3_ = 1 - Number(this.var_1132) / Number(this.var_407["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1132 > int(this.var_407["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1727;
         if(this._window.height < this.var_1728)
         {
            this._window.height = this.var_1728;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_180.orientation == "TOP" ? int(const_412) : 0;
         var _loc4_:int = this.var_180.orientation == "BOTTOM" ? int(_loc2_.height - const_412) : int(_loc2_.height);
         var _loc5_:int = this.var_180.orientation == "LEFT" ? int(const_412) : 0;
         var _loc6_:int = this.var_180.orientation == "RIGHT" ? int(_loc2_.width - const_412) : int(_loc2_.width);
         if(this.var_407["position_horizontal_follow_toolbar"] == "true" && (this.var_180.orientation != "TOP" && this.var_180.orientation != "BOTTOM"))
         {
            if(this.var_180.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_525;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_525;
            }
         }
         else if(this.var_407["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_525;
         }
         else
         ...
         if(this.var_407["position_vertical_follow_toolbar"] == "true" && (this.var_180.orientation != "RIGHT" && this.var_180.orientation != "LEFT"))
         {
            if(this.var_180.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_731;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_731;
            }
         }
         else if(this.var_407["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_731;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_730;
      }
   }
}
