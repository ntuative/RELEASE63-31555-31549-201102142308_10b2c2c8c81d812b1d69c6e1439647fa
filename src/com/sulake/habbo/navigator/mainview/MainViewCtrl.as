package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_910:int = 1;
      
      private static const const_581:int = 2;
      
      private static const const_909:int = 3;
      
      private static const const_1272:int = 4;
      ...
      private var var_881:GuestRoomListCtrl;
      
      private var var_1085:OfficialRoomListCtrl;
      ...
      private var var_1084:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_881 = new GuestRoomListCtrl(this._navigator);
         this.var_1085 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_881,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1513,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_178,["custom_content","list_content"],this.var_210.y,8);
         this.var_196.height = this.var_196.height + _loc1_ - this.var_196.y - this.var_243.height + this.var_2216;
         Util.moveChildrenToColumn(this.var_178,["list_content","custom_footer"],this.var_196.y,0);
         this.var_2216 = this.var_243.height;
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_210);
         if(Util.hasVisibleChildren(this.var_210))
         {
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_243);
         if(Util.hasVisibleChildren(this.var_243))
         {
            this.var_243.visible = true;
         }
         else
         {
            this.var_243.visible = false;
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_881,"guest_rooms");
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1085,"official_rooms");
      }
      ...
      public function startSearch(param1:int, param2:int, param3:String = "-1", param4:int = 1) : void
      {
         ...
         if(param4 == const_573)
         {
            this._navigator.send(this.method_9(param2,param3));
         }
      ...
      private function method_9(param1:int, param2:String) : IMessageComposer
      {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_569 == const_910)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_196.blend - _loc2_));
            this.var_196.blend = _loc3_;
            this.var_210.blend = !!this.var_1086 ? Number(_loc3_) : Number(1);
            this.var_243.blend = !!this.var_1086 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_569 = const_581;
            }
         }
         else if(this.var_569 == const_581)
         {
            if(this.var_1329 % 10 == 1)
            {
            ...
            {
               this.var_569 = const_909;
            }
         }
         else if(this.var_569 == const_909)
         {
            this.refresh();
            this.var_569 = const_1272;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_881);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1084,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1084,"icon_hotelview_reactive",param1,null,0);
      }
