package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1835:TextSearchInputs;
      ...
      {
         var _loc4_:* = null;
         if(this.var_1835 == null)
         {
            _loc4_ = param1.getChildByName("search_header") as IWindowContainer;
            this.var_1835 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1835.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_340)
            {
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_216,Tabs.const_233,"-1",MainViewCtrl.const_686);
      }
