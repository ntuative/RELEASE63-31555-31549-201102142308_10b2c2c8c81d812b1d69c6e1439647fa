package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_392);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_823);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_392,"" + _loc3_);
         }
      }
   }
}
