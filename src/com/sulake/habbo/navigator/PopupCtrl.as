package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_416 = new Timer(500,1);
         this.var_354 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_993 = param4;
         this.var_2411 = param2;
         this._popupIndentLeft = param3;
         this.var_416.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_416)
         {
            this.var_416.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_416.reset();
            this.var_416 = null;
         }
         if(this.var_354)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_52 == null)
         {
            this.var_52 = IWindowContainer(this._navigator.getXmlWindow(this.var_993));
         ...
         this.var_52.x = _loc2_.x + this.var_2411 + param1.width;
