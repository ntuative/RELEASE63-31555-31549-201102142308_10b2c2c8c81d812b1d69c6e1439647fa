package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1192:TextFieldManager;
      
      private var var_42:Array;
      
      private var var_1191:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_624 = new Timer(100);
         this.var_624.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_42 = new Array();
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,80,"g"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,74,"h"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,416,"o"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,352,"p"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,304,"q"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,336,"r"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,748,"u"));
         this.var_42.push(new RoomLayout(HabboClubLevelEnum.const_62,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_624)
         {
            this.var_624.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_624.reset();
            this.var_624 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1191.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1869 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1869 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_55 = IItemListWindow(this.var_178.findChildByName("item_list"));
         ...
         this.var_1192 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1192.goBackToInitialState();
         this.var_1192.input.textBackgroundColor = 4294967295;
         this.var_1191 = this.var_42[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_58,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1192.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1192.getText();
         var _loc3_:String = "model_" + this.var_1191.name;
