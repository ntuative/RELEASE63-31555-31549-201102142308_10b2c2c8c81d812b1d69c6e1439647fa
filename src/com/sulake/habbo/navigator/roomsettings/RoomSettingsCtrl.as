package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_385:IRoomSettingsCtrlOwner;
      ...
      private var var_660:TextFieldManager;
      ...
      private var var_544:ICheckBoxWindow;
      ...
      {
         this.var_322 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_322));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1525 = true;
         this.var_385.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_322)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_322 || this.var_1031 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1031 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1375)
         {
            this.var_660.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1609)
         {
            this.var_660.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1503)
         {
            this.var_1024.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1548)
         {
            this.setTagError(this.var_816,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_817,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1567)
         {
            this.setTagError(this.var_816,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_817,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1599)
         {
            this.var_818.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_660.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_780,this.onDoorModePasswordUnselect);
         ...
         this.var_660 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1024 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_816 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_817 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_818 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1026 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1029 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1028 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1023 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_544 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1523 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1258 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1027 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1025 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1524 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1259 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_235 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1030 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2030 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2029 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1522 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1522.procedure = this.onSwitchView;
         this.var_1030.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1523.visible = this._inRoom;
         this.var_1524.visible = this._inRoom;
         this.var_2029.visible = this.var_455;
         this.var_2030.visible = !this.var_455;
         if(this.var_455)
         {
         ...
         {
            this.populateForm();
            this.var_1027.visible = true;
            this.var_1259.visible = true;
            this.var_1258.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1258.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1027.height = Util.getLowestPoint(this.var_1027) + 4;
         }
         this.var_1522.text = !!this.var_455 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1523.name,this.var_1258.name,this.var_1027.name,this.var_1025.name,this.var_1259.name,this.var_1524.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_660.setText(_loc1_.name);
         this.var_1024.setText(_loc1_.description);
         this.var_818.setText("");
         this.var_1026.setText("");
         ...
         this.setTag(this.var_816,_loc1_.tags[0]);
         this.setTag(this.var_817,_loc1_.tags[1]);
         if(this.var_1029)
         {
            if(_loc1_.allowPets)
            {
               this.var_1029.select();
            }
            else
            {
               this.var_1029.unselect();
            }
         }
         if(this.var_1028)
         {
            ...
            {
               this.var_1028.select();
            }
            else
            {
               this.var_1028.unselect();
            }
         }
         if(this.var_1023)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_660.getText();
         _loc2_.description = this.var_1024.getText();
         ...
         {
            _loc8_ = this.var_818.getText();
            _loc9_ = this.var_1026.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_818.clearErrors();
               this.var_1026.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1029.isSelected;
         _loc2_.allowFoodConsume = this.var_1028.isSelected;
         _loc2_.allowWalkThrough = this.var_1023.isSelected;
         _loc2_.hideWalls = this.var_544.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_816,_loc2_.tags);
         this.addTag(this.var_817,_loc2_.tags);
         this.clearErrors();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_322);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_322]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_160,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_58,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_322));
      }
