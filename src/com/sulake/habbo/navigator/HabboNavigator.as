package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_300:MainViewCtrl;
      
      private var var_581:RoomInfoViewCtrl;
      
      private var var_1130:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_399:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2804:Dictionary;
      ...
      private var var_2409:RoomThumbnailRenderer;
      
      private var var_818:GuestRoomPasswordInput;
      
      private var var_320:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_300 = new MainViewCtrl(this);
         this.var_581 = new RoomInfoViewCtrl(this);
         this.var_1130 = new RoomCreateViewCtrl(this);
         this.var_2409 = new RoomThumbnailRenderer(this);
         this.var_818 = new GuestRoomPasswordInput(this);
         this.var_320 = new GuestRoomDoorbell(this);
         this.var_399 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_317,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_581.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         if(param1 != null && this.var_180 != null)
         {
            this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_300.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_300.startSearch(Tabs.const_216,Tabs.const_340,param1);
         this.var_300.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_300.startSearch(Tabs.const_315,Tabs.const_255);
         this.var_399.getTab(Tabs.const_315).tabPageDecorator.tabSelected();
      }
