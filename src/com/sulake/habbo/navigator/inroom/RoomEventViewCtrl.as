package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1829.visible = true;
         this.var_2571.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_759.setText(param1.eventDescription);
         this.var_816.setText(this.getTagFromEvent(param1,1));
         ...
         this.var_1828.visible = false;
         this.var_1827.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_957.visible = true;
         this.var_1829.visible = false;
         this.var_1422.visible = true;
         this.var_1421.visible = false;
         this.var_1423.visible = false;
         this.var_759.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_816.goBackToInitialState();
         this.var_817.goBackToInitialState();
         this.var_957.selection = 0;
         this.var_1828.visible = true;
         this.var_1827.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_957.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.addTag(_loc6_,this.var_816.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1829 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2571 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1828 = ITextWindow(this.find("create_caption"));
            this.var_1827 = ITextWindow(this.find("edit_caption"));
            this.var_1422 = IButtonWindow(this.find("create_button"));
            this.var_1421 = IButtonWindow(this.find("edit_button"));
            this.var_2570 = IButtonWindow(this.find("cancel_button"));
            this.var_1423 = IButtonWindow(this.find("end_button"));
            this.var_957 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1422,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1421,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1423,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2570,this.onCancelButtonClick);
            ...
            this.var_816 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
