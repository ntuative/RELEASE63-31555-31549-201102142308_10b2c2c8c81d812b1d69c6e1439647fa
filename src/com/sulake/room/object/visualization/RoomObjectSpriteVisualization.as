package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_443:int = -1;
      
      protected var var_163:int = -1;
      
      protected var var_187:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_770.removeReference();
         }
         this.var_770 = param1;
         if(this.var_770 != null)
         {
            this.var_770.addReference();
         }
      }
      ...
      {
         this.var_443 = 4294967295;
         this.var_163 = 4294967295;
         this.var_187 = -1;
      }
