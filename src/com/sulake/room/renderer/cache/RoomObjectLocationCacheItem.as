package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_349:Vector3d = null;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1618 || param1.getUpdateID() != this.var_2389)
         {
            this.var_2389 = param1.getUpdateID();
            if(param2.updateId != this.var_1618 || _loc4_.x != this.var_1126.x || _loc4_.y != this.var_1126.y || _loc4_.z != this.var_1126.z)
            {
               this.var_1618 = param2.updateId;
               this.var_1126.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2388 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     this.var_349 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     this.var_349.assign(_loc5_);
                  }
               }
               else
               {
            ...
            this.var_349.x = Math.round(this.var_349.x);
            this.var_349.y = Math.round(this.var_349.y);
         }
         return this.var_349;
      }
   }
