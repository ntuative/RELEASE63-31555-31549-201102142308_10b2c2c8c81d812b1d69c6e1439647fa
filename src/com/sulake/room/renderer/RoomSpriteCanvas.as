package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2669:Number = -1.0E7;
      
      private var var_2670:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_58 = new Sprite();
         this.var_58.name = "canvas";
         this.var_58.mouseEnabled = false;
         this.var_262.addChild(this.var_58);
         this.var_58.mouseEnabled = true;
         this.var_58.doubleClickEnabled = true;
         this.var_58.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_58.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
      ...
      {
         this.var_522.x -= param1 - this.var_635;
         this.var_635 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_522.y -= param1 - this.var_634;
         this.var_634 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_863 = true;
            if(this.var_132 != null && !this.var_262.contains(this.var_132))
            {
               this.var_262.addChild(this.var_132);
               this.var_58.mask = this.var_132;
            }
         }
         else if(!param1 && this.var_863)
         {
            this.var_863 = false;
            if(this.var_132 != null && this.var_262.contains(this.var_132))
            {
               this.var_262.removeChild(this.var_132);
               this.var_58.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_637.length)
            {
               this.cleanSprite(this.var_637[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_637 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_777 != this.var_2667 || this._ht != this.var_2671)
         {
            _loc9_ = true;
         }
         if(this.var_58.x != this.var_635 || this.var_58.y != this.var_634)
         {
            this.var_58.x = this.var_635;
            this.var_58.y = this.var_634;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_523[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2667 = this.var_777;
         this.var_2671 = this._ht;
      }
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_634;
                  if(_loc19_ < this.var_777 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.y = _loc20_ - this.var_634;
      ...
      {
         if(param1 < 0 || param1 >= this.var_58.numChildren)
         {
            return null;
         }
         return this.var_58.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_637.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_58.numChildren)
         {
            this.var_58.addChild(_loc3_);
         }
         else
         {
            this.var_58.addChildAt(_loc3_,param2);
         }
         ++this.var_778;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc6_:* = null;
         if(param1 >= this.var_58.numChildren)
         {
            this.createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = this.var_58.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_58.removeChildAt(param1);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_778 || this.var_778 == 0)
         {
            _loc5_ = this.var_58.numChildren - 1;
            while(_loc5_ >= param1)
            {
               _loc3_ = this.var_58.getChildAt(_loc5_);
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_635;
         param2 -= this.var_634;
         this.var_522.x = param1;
         this.var_522.y = param2;
         if(this.var_1203 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1903;
         }
         this.var_1903 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1203;
         return this.var_1903;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_777 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1904,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseClickHits(param1:Number, param2:Number, param3:Boolean, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         var _loc13_:* = [];
         var _loc14_:int = 0;
         _loc14_ = this.var_778 - 1;
         while(_loc14_ >= 0)
         {
            _loc10_ = this.var_58.getChildAt(_loc14_) as ExtendedSprite;
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2669 || param2 != this.var_2670)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      public function update() : void
      {
         if(this.var_1203 == 0)
         {
            this.checkMouseHits(this.var_522.x,this.var_522.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1203 = 0;
         ++this.var_1904;
      }
