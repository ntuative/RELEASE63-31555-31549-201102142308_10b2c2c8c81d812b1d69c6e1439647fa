package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1033:int = 2;
      ...
      private var var_48:IRoomContentLoader;
      ...
      private var var_2805:IRoomContentLoader;
      
      private var var_589:IRoomObjectFactory = null;
      
      private var var_493:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1142:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_835,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_589 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_589 == null || this.var_493 == null)
         {
            return;
         }
         this._state = const_1463;
         if(this.var_1142 != null)
         {
            _loc1_ = this.var_1142;
            this.var_1142 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         this.var_1022 = 50;
         this.var_154 = param2;
         var _loc3_:Array = this.var_48.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            ...
            {
               this.var_48.loadObjectContent(_loc5_,events);
               this.var_590.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1033;
         return true;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!this.var_48.hasInternalContent(param3))
         {
            _loc7_ = this.var_48.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               this.var_48.loadObjectContent(param3,events);
               _loc12_ = this.var_48.getPlaceHolderType(param3);
               _loc7_ = this.var_48.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = this.var_48.getVisualizationXML(_loc12_);
            _loc9_ = this.var_48.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = this.var_48.getVisualizationType(_loc12_);
            _loc11_ = this.var_48.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_589.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_589 != null)
         {
            return this.var_589.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(this.var_48 != null)
         {
            if(this.var_48.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc3_:XML = this.var_48.getVisualizationXML(_loc2_);
         if(_loc3_ == null)
         {
            if(this.var_154 != null)
            {
         ...
         var _loc4_:IGraphicAssetCollection = this.var_48.getGraphicAssetCollection(_loc2_);
         if(_loc4_ == null)
         {
            if(this.var_154 != null)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_48 == null || this.var_493 == null)
         {
            return;
         }
         var _loc2_:XML = this.var_48.getVisualizationXML(param1);
         var _loc3_:XML = this.var_48.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = this.var_48.getGraphicAssetCollection(param1);
               ...
               while(_loc10_ >= 0)
               {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        _loc16_ = this.var_48.getContentType(_loc15_);
                        if(_loc16_ == param1)
                        {
                           _loc17_ = this.var_48.getVisualizationType(_loc15_);
                           _loc18_ = this.var_48.getLogicType(_loc15_);
                           _loc5_ = this.var_493.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_493.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_589.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_154 != null)
                                 {
                                    this.var_154.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
