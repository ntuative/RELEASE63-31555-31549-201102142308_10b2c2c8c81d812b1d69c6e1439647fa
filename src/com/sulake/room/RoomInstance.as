   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_264 != null)
         {
            ...
            {
               _loc3_ = this.var_264.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1455.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_161 != null)
            {
               this.var_161.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      {
         return this.var_264.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_264.getValue(_loc2_) != null)
         {
            return this.var_264.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_264.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_264.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_264.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
