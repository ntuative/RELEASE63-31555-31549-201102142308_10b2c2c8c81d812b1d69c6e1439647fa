package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_848:Number = 64;
      
      public static const const_1170:Number = 32;
      ...
      private var var_381:Number = 1.0;
      
      private var var_383:Number = 1.0;
      
      private var var_1509:Number = 1.0;
      
      private var var_1510:Number = 1.0;
      
      private var var_1511:Number = 1.0;
      ...
      private var var_2744:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1511 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      public static function getIntersectionVector(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d) : IVector3d
      {
         ...
         var _loc6_:Vector3d = Vector3d.method_1(param1,param3);
      ...
      {
         return new Vector3d(this.var_167.x,this.var_167.y,this.var_167.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_74.x * this.var_382,this.var_74.y * this.var_381,this.var_74.z * this.var_383);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_232.x,this.var_232.y,this.var_232.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_382 != param1 * this.var_1509)
         {
            this.var_382 = param1 * this.var_1509;
            ++this.var_141;
         }
      }
      ...
      {
         if(this.var_381 != param1 * this.var_1510)
         {
            this.var_381 = param1 * this.var_1510;
            ++this.var_141;
         }
      }
      ...
      {
         if(this.var_383 != param1 * this.var_1511)
         {
            this.var_383 = param1 * this.var_1511;
            ++this.var_141;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_232.x;
         var _loc3_:Number = this.var_232.y;
         var _loc4_:Number = this.var_232.z;
         this.var_232.assign(param1);
         if(this.var_232.x != _loc2_ || this.var_232.y != _loc3_ || this.var_232.z != _loc4_)
         {
            ++this.var_141;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1012.assign(_loc22_);
         }
         else
         {
            this.var_1012.assign(_loc17_);
         }
         ++this.var_141;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.method_1(param1,this.var_74);
         _loc2_.x *= this.var_382;
         _loc2_.y *= this.var_381;
         _loc2_.z *= this.var_383;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1012);
         if(_loc3_ < this.var_2745 || _loc3_ > this.var_2744)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.method_1(param1,this.var_74);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_382;
            _loc2_.y *= this.var_381;
            _loc2_.z *= this.var_383;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1012);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_74.x * this.var_382,this.var_74.y * this.var_381,this.var_74.z * this.var_383);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_167;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_382,param2.y * this.var_381,param2.z * this.var_383);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_382,param3.y * this.var_381,param3.z * this.var_383);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_382,param4.y * this.var_381,param4.z * this.var_383);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1170;
         }
         else
         {
            this.scale = const_848;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_848;
      }
