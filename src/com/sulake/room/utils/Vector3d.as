package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public static function method_1(param1:IVector3d, param2:IVector3d) : Vector3d
      {
         if(param1 == null || param2 == null)
         {
            return null;
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_168 * this.var_168 + this.var_167 * this.var_167);
         }
         return this._length;
      }
