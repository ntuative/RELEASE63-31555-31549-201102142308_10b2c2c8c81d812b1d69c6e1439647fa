package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1153:String = "AssetLibraryReady";
      
      public static const const_876:String = "AssetLibraryLoaded";
      
      public static const const_1502:String = "AssetLibraryUnloaded";
      
      public static const const_1538:String = "AssetLibraryLoadError";
      
      private static var var_302:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_491:uint = 0;
      
      private static var var_925:Array = new Array();
      ...
      private var var_739:XML;
      
      private var var_926:Boolean;
      
      private var var_410:uint;
      
      private var var_40:LibraryLoader;
      
      private var var_588:Class;
      
      private var var_924:Dictionary;
      
      private var var_153:Dictionary;
      
      private var var_923:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_491;
         this.var_409 = new Dictionary(false);
         this.var_490 = new Dictionary(false);
         this.var_924 = new Dictionary(false);
         this.var_153 = new Dictionary(false);
         var_925.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_925.splice(var_925.indexOf(this),1);
            --var_491;
            this.var_490 = null;
            this.var_924 = null;
            this.var_153 = null;
      ...
      {
         if(this._file == param1.url && this.var_926)
         {
            if(!this.var_923 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_739,this.var_588);
            }
            this.var_923 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1153));
         }
         else
         {
            if(this.var_40 == null || this.var_40.disposed)
            {
               this.var_40 = param1;
               this.var_40.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
               this.var_40.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            }
            this.var_923 = param2;
            this._file = this.var_40.url;
         }
      }
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_490)
         {
            _loc2_ = this.var_490[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_490[_loc1_];
         }
         for(_loc1_ in this.var_153)
         {
            delete this.var_153[_loc1_];
         }
         for(_loc1_ in this.var_924)
         {
            delete this.var_924[_loc1_];
         }
         if(this.var_40 != null)
         {
            this.var_40.dispose();
      ...
      {
         var _loc2_:Class = this.var_924[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(this.var_40 != null)
         {
            if(this.var_40.hasDefinition(param1))
            {
               _loc2_ = this.var_40.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  this.var_924[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_490[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1000,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1018,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1072,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1102,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_490[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_490[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_153[struct.assetName] == null)
                  {
                     ++this.var_410;
                     this.var_411.push(struct.assetName);
                  }
                  this.var_153[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_44,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_490[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_153[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_411.length ? this.getAssetByName(this.var_411[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_153)
         {
            if(this.var_153[_loc2_] == param1)
            {
               return this.var_411.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_153[param1] != null || (this.var_588 != null ? this.var_588[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_153[param1] == null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_409.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_409[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_409[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_409)
         {
            _loc3_ = AssetTypeDeclaration(this.var_409[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc4_ = AssetTypeDeclaration(this.var_409[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_739 = _loc2_.manifest.copy();
         this.var_588 = _loc2_.resource;
         ...
         this.var_926 = true;
         dispatchEvent(new Event(AssetLibrary.const_876));
         dispatchEvent(new Event(AssetLibrary.const_1153));
         if(this.var_923)
         {
            this.var_40.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
            this.var_40.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            this.var_40.addEventListener(LibraryLoader.LIBRARY_LOADER_FINALIZE,this.finalizeLoaderEventHandler);
            this.var_40 = null;
            this.var_588 = null;
         }
      }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1538));
         this.var_40 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_739.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_588[param1]);
