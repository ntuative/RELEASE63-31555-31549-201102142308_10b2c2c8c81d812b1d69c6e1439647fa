package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_477:uint = 0;
      ...
      private var var_1498:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_477 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_105 is BitmapDataAsset)
         {
            ...
            this.var_1300 = BitmapDataAsset(this.var_105).var_1300;
            this.var_1299 = BitmapDataAsset(this.var_105).var_1299;
            if(this._bitmap != null)
            {
               this.var_105 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1300 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1299 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
