package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_376:Rectangle;
      ...
      protected var var_440:Boolean = false;
      
      protected var var_230:uint = 16777215;
      
      protected var var_529:uint;
      
      protected var var_439:uint = 10;
      
      protected var var_796:Boolean = true;
      
      protected var var_377:Boolean = true;
      
      protected var var_730:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this._type = param3;
         this.var_18 = param5;
         this._state = WindowState.const_93;
         this.var_80 = param4;
         this.var_797 = param8 == null ? new Array() : param8;
         this.var_16 = param6;
         this.var_11 = param7.clone();
         this.var_376 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_16 = null;
            this._state = WindowState.const_485;
            this.var_797 = null;
         }
      }
      ...
      {
         return this.var_376.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_376.height;
      }
