package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_940:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1781:StyleSheet = null;
      ...
      {
         this.var_752 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1151 == param2)
         {
            return;
         }
         param1.var_1151 = param2;
         param1.var_1781 = null;
         if(param1.var_1151 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1151);
            param1.var_1781 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_849.indexOf(param1) > -1)
         {
            this.var_752 = param1;
         }
      }
      ...
      {
         return this.var_752 == LinkTarget.const_31 ? defaultLinkTarget : this.var_752;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1781;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_752 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_748,this.var_752,PropertyStruct.const_51,true,PropertyDefaults.const_849));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1582);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_748)
            {
               this.var_752 = _loc2_.value as String;
               break;
            }
