package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1267:String = "_SELECTOR";
      
      private static const const_1268:String = "_CONTENT";
       
      
      protected var var_988:ITabSelectorWindow;
      
      protected var var_1965:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_988 = findChildByTag(const_1267) as ITabSelectorWindow;
            if(this.var_988 != null)
            {
               this.var_988.procedure = this.selectorEventProc;
            }
         }
         return this.var_988;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1965 = findChildByTag(const_1268) as IWindowContainer;
         }
      ...
      {
         return this.var_988.numSelectables;
      }
