package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1227:String = "_TITLE";
      
      private static const const_1274:String = "_HEADER";
      
      private static const const_1273:String = "_CONTENT";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1227) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1330 = findChildByTag(const_1274) as IHeaderWindow;
            if(!this.var_1330)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_178 = findChildByTag(const_1273) as IWindowContainer;
            if(!this.var_178)
            {
      ...
      {
         return this.content != null && this.var_987 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_295,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_217,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_214,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
