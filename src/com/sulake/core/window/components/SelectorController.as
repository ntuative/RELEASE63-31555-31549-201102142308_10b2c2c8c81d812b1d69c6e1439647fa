package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_199:ISelectableWindow;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_228)
         {
      ...
      {
         return this.var_199 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_199)
            {
               if(this.var_199 != null)
               {
                  this.var_199.unselect();
               }
               this.var_199 = param1;
               this.var_199.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_352,this,this.var_199));
               }
            }
         }
      }
