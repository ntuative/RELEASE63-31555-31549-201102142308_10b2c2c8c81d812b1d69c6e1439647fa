package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1973:Boolean = false;
      ...
      protected var var_2785:Number = 0.0;
      
      protected var var_2784:Number = 0.0;
      
      protected var var_991:Boolean = true;
      
      protected var var_442:Boolean = false;
      
      protected var var_1230:Boolean = false;
      
      protected var var_1972:int = 0;
      
      protected var var_1974:int = 0;
      
      protected var var_1233:Number;
      
      protected var var_1232:Number;
      
      protected var var_1231:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_102 = 0;
         this.var_92 = 0;
         this._horizontal = param2 == WindowType.const_327;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_162 = var_440 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_332,WindowStyle.const_727,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_47,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_493,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_297,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_542,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1230;
      }
      ...
      {
         return new Rectangle(this.var_647 * this.maxScrollH,this.var_648 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_647)
         {
            ...
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_67);
            dispatchEvent(new WindowEvent(WindowEvent.const_454,this,null));
         }
      }
      ...
      {
         this.var_2785 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_477,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_493,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_297,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_542,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_41:
               this.var_1972 = _loc3_;
               this.var_1974 = _loc4_;
               this.var_1233 = 0;
               this.var_1232 = 0;
               this.var_1231 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_189:
               if(this.var_1231)
               {
                  this.var_1233 = this.var_1972 - _loc3_;
                  this.var_1232 = this.var_1974 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1233 != 0 && this.var_102 != 0)
                     {
                        this.scrollH += this.var_1233 / this.var_102;
                     }
                  }
                  else if(this.var_1232 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1232 / this.var_92;
                  }
                  this.var_1972 = _loc3_;
                  this.var_1974 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_183:
               if(this.var_1231)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1233,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1232);
                  }
                  this.var_1231 = false;
                  _loc2_ = true;
               }
      ...
      private function containerEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case WindowEvent.const_493:
               this.updateScrollAreaRegion();
               break;
            case WindowEvent.const_297:
               if(!this.var_1973)
               {
                  this.updateScrollAreaRegion();
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_991 && !this.var_531 && this._container)
         {
            this.var_531 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_398,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1069);
         }
         if(this.var_991 != PropertyDefaults.const_1158)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_828,this.var_991,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1447);
         }
         if(this.var_442 != PropertyDefaults.const_1123)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_662,this.var_442,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1580);
         }
         if(this.var_1230 != PropertyDefaults.const_1012)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_717,this.var_1230,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1477);
         }
         return _loc1_;
      }
