package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2627 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_365 != _loc2_.color : this.var_365 != null && this.var_365 != PropertyDefaults.const_734) ? new PropertyStruct(PropertyDefaults.const_377,this.var_365,PropertyStruct.const_138,true) : PropertyDefaults.const_1023);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_610)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,this.var_39.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_449);
            }
            if(this.var_39.top != PropertyDefaults.const_754)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_217,this.var_39.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_424);
            }
            if(this.var_39.right != PropertyDefaults.const_769)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,this.var_39.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_517);
            }
            if(this.var_39.bottom != PropertyDefaults.const_752)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_214,this.var_39.bottom,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_553);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_376:
                  ...
                  break;
               case PropertyDefaults.const_377:
