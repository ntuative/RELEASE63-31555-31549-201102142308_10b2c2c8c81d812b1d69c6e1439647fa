package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_258.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_559,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_175 == null || this.var_175.disposed)
         {
            this.var_175 = context.create(name + "::submenu","",WindowType.const_539,var_80,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_258.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_938 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_938)
         {
            if(this.open())
            {
               if(this.var_258.length)
               {
                  this.populateMenuItemContainer(this.var_258,this.getSubMenu(),this.subMenuEventProc);
                  this.var_938 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_938 = false;
            this.getTitleLabel().text = this.var_602 < this.var_258.length && this.var_602 > -1 ? this.var_258[this.var_602] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_535,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_332,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_602 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_602).setStateFlag(WindowState.const_49,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1031:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_884:
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_258[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_258.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_791,this.var_258,PropertyStruct.const_128,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_791)
            {
