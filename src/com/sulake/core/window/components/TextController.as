package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_532:Number;
      
      protected var var_533:Boolean;
      ...
      protected var var_996:Boolean = false;
      ...
      private static function method_12(param1:TextController, param2:Boolean) : void
      {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_174);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_868 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_803 * this.maxScrollH,this.var_532 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1199) ? new PropertyStruct(PropertyDefaults.const_634,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1179) : PropertyDefaults.const_1530);
         _loc1_.push(this._autoSize != PropertyDefaults.const_970 ? new PropertyStruct(PropertyDefaults.const_670,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1042) : PropertyDefaults.const_1557);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_138,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1050 ? new PropertyStruct(PropertyDefaults.const_1020,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1067) : PropertyDefaults.const_1522);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_734) ? new PropertyStruct(PropertyDefaults.const_377,this._field.textColor,PropertyStruct.const_138,true) : PropertyDefaults.const_1023);
         _loc1_.push(this.var_432 != TextStyleManager.const_174 ? new PropertyStruct(PropertyDefaults.const_376,this.var_432,PropertyStruct.const_51,true,PropertyDefaults.const_749) : PropertyDefaults.const_1193);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_610 ? new PropertyStruct(PropertyDefaults.const_232,this.var_39.left,PropertyStruct.const_38,true) : PropertyDefaults.const_449);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_754 ? new PropertyStruct(PropertyDefaults.const_217,this.var_39.top,PropertyStruct.const_38,true) : PropertyDefaults.const_424);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_769 ? new PropertyStruct(PropertyDefaults.const_251,this.var_39.right,PropertyStruct.const_38,true) : PropertyDefaults.const_517);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_752 ? new PropertyStruct(PropertyDefaults.const_214,this.var_39.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_553);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1149 ? new PropertyStruct(PropertyDefaults.const_773,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1498);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_238,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_238,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_238,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
