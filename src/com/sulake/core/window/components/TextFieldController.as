package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1237 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_557)
         {
            this.focus();
         }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_399,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_705,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1576);
         _loc1_.push(this.var_1228 != PropertyDefaults.const_1093 ? new PropertyStruct(PropertyDefaults.const_880,this.var_1228,PropertyStruct.const_37,true) : PropertyDefaults.const_1508);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1084 ? new PropertyStruct(PropertyDefaults.const_862,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1401);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1002 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1481);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_880:
                  this.var_1228 = _loc2_.value as Boolean;
                  if(this.var_1228)
                  {
               ...
               case PropertyDefaults.const_705:
                  ...
                  break;
               case PropertyDefaults.const_1063:
