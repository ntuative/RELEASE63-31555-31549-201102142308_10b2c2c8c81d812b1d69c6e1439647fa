package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1158:uint = 0;
      ...
      protected static const const_1651:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1406:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_730 = _loc13_.blend;
            var_439 = _loc13_.var_2719;
      ...
      {
         var_440 = param1;
         var_230 = !!var_440 ? uint(var_230 | var_529) : uint(var_230 & 16777215);
      ...
      {
         var_796 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_421,this,null));
      }
      ...
      {
         var_529 = param1 << 24;
         var_230 = !!var_440 ? uint(var_529 | var_230) : uint(16777215 & var_230);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_67);
      }
      
      public function set blend(param1:Number) : void
      {
         var_730 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1029);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_80 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_519,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_356 = this._parent.rectangle.clone();
               var_59.x = var_11.x;
               var_59.y = var_11.y;
               var_59.width = var_11.width;
               var_59.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_438,this,this._parent));
            }
            else
            {
               this.var_356.x = 0;
               this.var_356.y = 0;
               this.var_356.width = 0;
               this.var_356.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1148,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_18,var_16,var_11,null,this.var_649,this.properties,var_797.concat(),_id) as WindowController;
         _loc2_.var_439 = var_439;
         _loc2_.var_162 = this.var_162;
         _loc2_._debug = this._debug;
         _loc2_.var_356 = this.var_356.clone();
         ...
         _loc2_.var_796 = var_796;
         _loc2_.var_377 = var_377;
         _loc2_.var_730 = var_730;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2515 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_505)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_523)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1160,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_882,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_518,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_166,this,null));
            }
         }
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param4 != null && var_136 != null)
         {
            param4.x = var_136.x;
            param4.y = var_136.y;
            param4.width = var_136.width;
            param4.height = var_136.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_136.x = param3.x;
            var_136.y = param3.y;
            var_136.width = param3.width;
            var_136.height = param3.height;
         }
         if(param2 != null)
         {
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_612))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1145;
                  if(testParamFlag(WindowParam.const_397))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_166:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_563,this,null));
                     if(testParamFlag(WindowParam.const_176,WindowParam.const_152))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_184,WindowParam.const_150))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_477))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_531))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_310,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_518:
                  var_16.invalidate(this,var_11.union(var_59),WindowRedrawFlag.const_440);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1127,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_300,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_385:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_703,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_228,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_536:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_993);
                  break;
               case WindowNotifyEvent.const_519:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1651) == -1)
                     {
                        _loc8_.style = var_80;
                     }
                  }
               ...
               case WindowNotifyEvent.const_421:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_440);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_438:
                  ...
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_67);
                  break;
               case WindowNotifyEvent.const_228:
                  this.activate();
                  break;
               case WindowNotifyEvent.const_563:
                  this._parent.getRegionProperties(null,this.var_356);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1151:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1424:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1578:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_678:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_618:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_996:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1159:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1030:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1110:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_519:
               _loc2_ = "null";
            ...
            case WindowNotifyEvent.const_421:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_703:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_228:
               _loc2_ = "null";
         ...
         if(this.var_162 && var_439 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1406,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1406,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_130,WindowParam.const_152);
         var _loc2_:* = !testParamFlag(WindowParam.const_141,WindowParam.const_150);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_356.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_356.height;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_359)
               {
      ...
      {
         if(_state == WindowState.const_485)
         {
            return true;
         }
         _state = WindowState.const_485;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1154,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1159,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1064,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1157,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_1125;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_385;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1130,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_764;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_671;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1120,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_384,this,param1));
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_803,this,param1));
         return param1;
      }
