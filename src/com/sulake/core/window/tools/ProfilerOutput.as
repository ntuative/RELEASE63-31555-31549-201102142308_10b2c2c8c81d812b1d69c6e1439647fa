package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1363:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1362:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_152:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2766 = new Array();
         this.var_152 = this.profiler;
         this._windowManager = param2;
         this.var_850 = param3;
         var _loc4_:ByteArray = new var_1363() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_152)
         {
            this.var_152.removeStopEventListener(this.refresh);
            this.var_152 = null;
         }
         if(!this.var_152 && param1)
         {
            this.var_152 = param1;
            this.var_152.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_836)
            {
               this.var_1682 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_152.getProfilerAgentsInArray();
         ...
         if(this.var_1682)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_152.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_152.numBitmapAssetInstances + " / " + this.var_152.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_850.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_152.numTrackedBitmapDataInstances + " / " + this.var_152.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1362() as ByteArray;
