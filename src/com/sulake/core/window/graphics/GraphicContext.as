package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1777:uint = 64;
      
      public static const const_1775:uint = 128;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_186)
            {
               this.var_186 = new Shape();
               this.var_186.visible = false;
               this.var_186.cacheAsBitmap = true;
               super.addChild(this.var_186);
            }
            this.var_186.graphics.clear();
            this.var_186.graphics.beginFill(255);
            this.var_186.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_186.graphics.endFill();
            this.getDisplayObject().mask = this.var_186;
         }
         else if(this.var_186)
         {
            super.removeChild(this.var_186);
            this.var_186.graphics.clear();
            this.var_186 = null;
         ...
         if(this.var_802)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1975,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1975,16777215);
                  }
                  var_316 += bitmap.width * bitmap.height * 4;
               }
