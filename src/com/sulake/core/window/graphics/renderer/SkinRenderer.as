package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_375:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      protected var var_528:Dictionary;
      ...
      public function SkinRenderer(param1:String)
      {
         super();
         this._name = param1;
         this.var_375 = new Dictionary();
         this._templatesByState = new Dictionary();
         this.var_528 = new Dictionary();
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_528)
            {
               ISkinLayout(this.var_528[_loc1_]).dispose();
               delete this.var_528[_loc1_];
            }
            this.var_528 = null;
            this.var_438 = null;
            for(_loc1_ in this.var_375)
            {
               ISkinTemplate(this.var_375[_loc1_]).dispose();
               delete this.var_375[_loc1_];
            }
            this.var_375 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_375[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_528[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_375[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_438)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_438[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_528[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_375[param1.name];
         }
         return param1;
      }
   }
