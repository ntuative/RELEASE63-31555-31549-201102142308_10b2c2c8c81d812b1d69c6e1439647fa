package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_794:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_183;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_79 = param1.var_1220 as WindowController;
         this._lastClickTarget = param1.var_1219 as WindowController;
         this.var_161 = param1.renderer;
         this.var_794 = param1.var_1218;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_645.x || _loc3_.stageY != this.var_645.y)
            {
               this.var_645.x = _loc3_.stageX;
               this.var_645.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_135.groupParameterFilteredChildrenUnderPoint(this.var_645,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_79 != this.var_135 && !this.var_79.disposed)
                  {
                     ...
                     this.var_79 = WindowController(this.var_135);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_79 && !this.var_79.disposed)
                     {
                        ...
                        {
                           this.var_794.mouseEventReceived(_loc3_.type,this.var_79);
                        }
                     }
                  }
         ...
         param1.var_1220 = this.var_79;
         param1.var_1219 = this._lastClickTarget;
         param1.renderer = this.var_161;
         param1.var_1218 = this.var_794;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_429))
         {
