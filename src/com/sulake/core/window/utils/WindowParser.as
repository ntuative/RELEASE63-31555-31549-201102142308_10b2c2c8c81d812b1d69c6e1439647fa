package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1162:String = "_EXCLUDE";
      
      public static const const_1851:String = "_INCLUDE";
      
      public static const const_1728:String = "_TEMP";
      
      private static const const_1316:String = "layout";
      
      private static const const_942:String = "window";
      
      private static const const_940:String = "variables";
      
      private static const const_941:String = "filters";
      
      private static const const_593:String = "name";
      
      private static const const_1324:String = "style";
      
      private static const const_592:String = "params";
      
      private static const const_1320:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1295:String = "width";
      
      private static const const_1293:String = "height";
      
      private static const const_1317:String = "visible";
      
      private static const const_1318:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1029:String = "blend";
      
      private static const const_1321:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1322:String = "treshold";
      
      private static const const_1327:String = "children";
      
      private static const const_1314:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1326:String = "height_min";
      
      private static const const_1325:String = "height_max";
      
      private static const const_594:String = "true";
      
      private static const const_151:String = "0";
      
      private static const const_1315:String = "$";
      
      private static const const_1294:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1319:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1323:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1235:Dictionary;
      
      protected var var_1234:Dictionary;
      
      protected var var_992:Dictionary;
      
      protected var var_1482:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         super();
         this.var_16 = param1;
         this.var_1235 = new Dictionary();
         this.var_1234 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1235,this.var_1234);
         this.var_992 = new Dictionary();
         this.var_1482 = new Dictionary();
         ParamCodeTable.fillTables(this.var_992,this.var_1482);
         this.var_1980 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1323,const_48);
         return param1.replace(const_1319,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1235)
            {
               delete this.var_1235[_loc1_];
            }
            for(_loc1_ in this.var_1234)
            {
               delete this.var_1234[_loc1_];
            }
            for(_loc1_ in this.var_992)
            {
               delete this.var_992[_loc1_];
            }
            for(_loc1_ in this.var_1482)
            {
               delete this.var_1482[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1316)
         {
            _loc8_ = param1.child(const_940);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_941).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1235[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_593,variables,"")));
         style = uint(this.parseAttribute(xml,const_1324,variables,style));
         params = uint(this.parseAttribute(xml,const_592,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1320,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_151));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_151));
         rect.width = Number(this.parseAttribute(xml,const_1295,variables,const_151));
         rect.height = Number(this.parseAttribute(xml,const_1293,variables,const_151));
         visible = this.parseAttribute(xml,const_1317,variables,visible.toString()) == const_594;
         caption = unescape(String(this.parseAttribute(xml,const_1318,variables,caption)));
         ...
         if(xml.child(const_592).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_593,variables,"") as String;
               if(this.var_992[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_593)) + "\"!");
               }
               params |= this.var_992[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1294);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_940)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1314,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1326,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1325,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_594;
         blend = Number(this.parseAttribute(xml,const_1029,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1321,variables,window.clipping.toString()) == const_594;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1322,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_941).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_184)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1234[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1162) == -1)
                  {
