package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2758 = param3 == const_266 || param3 == const_128 || param3 == const_250 || param3 == const_225;
         this.var_2126 = param5;
      }
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_37:
               return Boolean(this.var_166) == true ? "true" : "HabboNavigatorCom_roc_create_room_xml";
            case const_250:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_225:
               ...
               break;
            case const_138:
               _loc1_ = "<var key=\"" + this.var_563 + "\" value=\"" + "0x" + uint(this.var_166).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_563 + "\" value=\"" + this.var_166 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
