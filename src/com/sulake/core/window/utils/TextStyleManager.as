package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_174:String = "regular";
      ...
      private static var var_503:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_595:String = "{";
      
      private static const const_596:String = "}";
      
      private static const const_1330:String = "/*";
      
      private static const const_1329:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_174],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_174] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_503.indexOf(_loc4_.name) == -1)
            {
               var_503.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_596);
         if(countSubStrings(param1,const_595) != countSubStrings(param1,const_596))
         {
            throw new Error("Mismatching amount of \"" + const_595 + "\" versus \"" + const_596 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1330) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1329) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_595)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
