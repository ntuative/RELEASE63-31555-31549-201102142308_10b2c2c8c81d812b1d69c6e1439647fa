package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1296:String = "asset-libraries";
      
      private static const const_1302:String = "library";
      
      private static const const_1304:String = "service-libraries";
      
      private static const const_1298:String = "library";
      
      private static const const_1300:String = "component-libraries";
      
      private static const const_1301:String = "library";
      
      private static const const_1303:String = "error_data";
      
      private static const const_1299:String = "error_cat";
      
      private static const const_1297:String = "error_desc";
       
      
      private var var_352:LibraryLoaderQueue;
      
      private var var_732:IEventDispatcher;
      
      private var var_486:uint;
      
      private var var_487:Function;
      
      private var var_254:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_488.push(new Array());
            this.var_585.push(0);
            _loc3_++;
         }
         this.var_1738 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_441.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            ...
            case Core.const_1418:
               ...
               this.var_254 = new Profiler(this);
               attachComponent(this.var_254,[new IIDProfiler()]);
               var_441.addChild(new ProfilerViewer(this.var_254));
               break;
      ...
      {
         return this.var_352.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_486 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_441.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_441 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_148)
            {
               _loc2_ = this.var_488[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1303,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1299,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_732 = loadingEventDelegate;
         if(this.var_352 == null)
         {
            this.var_352 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         try
         {
            node = config.child(const_1304)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1467);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_732)
         {
            this.var_732.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_732)
         {
            ...
            this.var_732.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_732)
                  {
                     this.var_732.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_486 - this.var_352.length,this.var_486,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_488[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_488[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_487(_loc2_,_loc2_ - this.var_1738);
         this.var_1738 = _loc2_;
      }
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_585[criticality] = 0;
            receivers = this.var_488[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_441.stage.frameRate;
         criticality = 0;
         while(criticality < CoreComponentContext.const_148)
         {
            t = getTimer();
            ...
            {
               if(this.var_585[criticality] < criticality)
               {
                  ++this.var_585[criticality];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(criticality < CoreComponentContext.const_148)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_254.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      private function debugFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(_loc3_ < CoreComponentContext.const_148)
         {
            this.var_585[_loc3_] = 0;
            _loc4_ = this.var_488[_loc3_];
            _loc7_ = 0;
