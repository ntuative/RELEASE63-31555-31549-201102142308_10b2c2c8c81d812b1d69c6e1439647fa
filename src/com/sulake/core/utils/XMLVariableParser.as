package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_138:String = "hex";
      ...
      public static const const_1532:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1386:String = "bool";
      
      public static const const_51:String = "String";
      
      public static const const_250:String = "Point";
      
      public static const const_225:String = "Rectangle";
      ...
      private static const const_1681:String = "HabboNavigatorCom_roc_create_room_xml";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_266 || _loc5_ == const_128)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_138:
               return uint(param1);
            case const_128:
               return param1.split(const_1294);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_225:
               ...
               _loc5_.width = Number(param1.attribute(const_1295));
               _loc5_.height = Number(param1.attribute(const_1293));
               return _loc5_;
            case const_128:
               _loc3_ = new Map();
